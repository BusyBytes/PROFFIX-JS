...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.ADRKontakttypKontakttypNr();
  });
  ...
  describe('ADRKontakttypKontakttypNr', function() {
    it('should create an instance of ADRKontakttypKontakttypNr', function() {
      // uncomment below and update the code to test ADRKontakttypKontakttypNr
      //var instance = new ProffixRestApiRequestSammlung.ADRKontakttypKontakttypNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.ADRKontakttypKontakttypNr);
    });
