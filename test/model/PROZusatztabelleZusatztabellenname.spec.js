...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROZusatztabelleZusatztabellenname();
  });
  ...
  describe('PROZusatztabelleZusatztabellenname', function() {
    it('should create an instance of PROZusatztabelleZusatztabellenname', function() {
      // uncomment below and update the code to test PROZusatztabelleZusatztabellenname
      //var instance = new ProffixRestApiRequestSammlung.PROZusatztabelleZusatztabellenname();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROZusatztabelleZusatztabellenname);
    });
