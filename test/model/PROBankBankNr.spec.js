...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROBankBankNr();
  });
  ...
  describe('PROBankBankNr', function() {
    it('should create an instance of PROBankBankNr', function() {
      // uncomment below and update the code to test PROBankBankNr
      //var instance = new ProffixRestApiRequestSammlung.PROBankBankNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROBankBankNr);
    });

    it('should have the property bankNr (base name: "BankNr")', function() {
      // uncomment below and update the code to test the property bankNr
      //var instance = new ProffixRestApiRequestSammlung.PROBankBankNr();
    ...
    it('should have the property clearingNummer (base name: "ClearingNummer")', function() {
      // uncomment below and update the code to test the property clearingNummer
      //var instance = new ProffixRestApiRequestSammlung.PROBankBankNr();
      //expect(instance).to.be();
    });
    ...
    it('should have the property serverTyp (base name: "ServerTyp")', function() {
      // uncomment below and update the code to test the property serverTyp
      //var instance = new ProffixRestApiRequestSammlung.PROBankBankNr();
      //expect(instance).to.be();
    });
