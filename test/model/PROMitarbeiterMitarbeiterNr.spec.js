...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROMitarbeiterMitarbeiterNr();
  });
  ...
  describe('PROMitarbeiterMitarbeiterNr', function() {
    it('should create an instance of PROMitarbeiterMitarbeiterNr', function() {
      // uncomment below and update the code to test PROMitarbeiterMitarbeiterNr
      //var instance = new ProffixRestApiRequestSammlung.PROMitarbeiterMitarbeiterNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROMitarbeiterMitarbeiterNr);
    });
    ...
    it('should have the property funktion (base name: "Funktion")', function() {
      // uncomment below and update the code to test the property funktion
      //var instance = new ProffixRestApiRequestSammlung.PROMitarbeiterMitarbeiterNr();
      //expect(instance).to.be();
    });
