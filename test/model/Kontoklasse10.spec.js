...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Kontoklasse10();
  });
  ...
  describe('Kontoklasse10', function() {
    it('should create an instance of Kontoklasse10', function() {
      // uncomment below and update the code to test Kontoklasse10
      //var instance = new ProffixRestApiRequestSammlung.Kontoklasse10();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Kontoklasse10);
    });
