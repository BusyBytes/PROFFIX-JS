...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.STUTeilleistungsgruppeTeilleistungsgruppeNr();
  });
  ...
  describe('STUTeilleistungsgruppeTeilleistungsgruppeNr', function() {
    it('should create an instance of STUTeilleistungsgruppeTeilleistungsgruppeNr', function() {
      // uncomment below and update the code to test STUTeilleistungsgruppeTeilleistungsgruppeNr
      //var instance = new ProffixRestApiRequestSammlung.STUTeilleistungsgruppeTeilleistungsgruppeNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.STUTeilleistungsgruppeTeilleistungsgruppeNr);
    });

    it('should have the property teilleistungsgruppeNr (base name: "TeilleistungsgruppeNr")', function() {
      // uncomment below and update the code to test the property teilleistungsgruppeNr
      //var instance = new ProffixRestApiRequestSammlung.STUTeilleistungsgruppeTeilleistungsgruppeNr();
