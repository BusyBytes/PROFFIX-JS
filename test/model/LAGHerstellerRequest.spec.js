...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LAGHerstellerRequest();
  });
  ...
  describe('LAGHerstellerRequest', function() {
    it('should create an instance of LAGHerstellerRequest', function() {
      // uncomment below and update the code to test LAGHerstellerRequest
      //var instance = new ProffixRestApiRequestSammlung.LAGHerstellerRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LAGHerstellerRequest);
    });
