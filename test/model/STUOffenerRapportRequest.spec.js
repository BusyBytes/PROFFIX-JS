...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.STUOffenerRapportRequest();
  });
  ...
  describe('STUOffenerRapportRequest', function() {
    it('should create an instance of STUOffenerRapportRequest', function() {
      // uncomment below and update the code to test STUOffenerRapportRequest
      //var instance = new ProffixRestApiRequestSammlung.STUOffenerRapportRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.STUOffenerRapportRequest);
    });
