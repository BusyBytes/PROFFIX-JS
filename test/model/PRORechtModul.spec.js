...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PRORechtModul();
  });
  ...
  describe('PRORechtModul', function() {
    it('should create an instance of PRORechtModul', function() {
      // uncomment below and update the code to test PRORechtModul
      //var instance = new ProffixRestApiRequestSammlung.PRORechtModul();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PRORechtModul);
    });
