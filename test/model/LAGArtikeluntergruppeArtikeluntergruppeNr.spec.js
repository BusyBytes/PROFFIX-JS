...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LAGArtikeluntergruppeArtikeluntergruppeNr();
  });
  ...
  describe('LAGArtikeluntergruppeArtikeluntergruppeNr', function() {
    it('should create an instance of LAGArtikeluntergruppeArtikeluntergruppeNr', function() {
      // uncomment below and update the code to test LAGArtikeluntergruppeArtikeluntergruppeNr
      //var instance = new ProffixRestApiRequestSammlung.LAGArtikeluntergruppeArtikeluntergruppeNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LAGArtikeluntergruppeArtikeluntergruppeNr);
    });

    it('should have the property artikeluntergruppeNr (base name: "ArtikeluntergruppeNr")', function() {
      // uncomment below and update the code to test the property artikeluntergruppeNr
      //var instance = new ProffixRestApiRequestSammlung.LAGArtikeluntergruppeArtikeluntergruppeNr();
