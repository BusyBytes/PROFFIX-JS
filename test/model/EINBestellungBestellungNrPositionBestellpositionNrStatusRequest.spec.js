...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.EINBestellungBestellungNrPositionBestellpositionNrStatusRequest();
  });
  ...
  describe('EINBestellungBestellungNrPositionBestellpositionNrStatusRequest', function() {
    it('should create an instance of EINBestellungBestellungNrPositionBestellpositionNrStatusRequest', function() {
      // uncomment below and update the code to test EINBestellungBestellungNrPositionBestellpositionNrStatusRequest
      //var instance = new ProffixRestApiRequestSammlung.EINBestellungBestellungNrPositionBestellpositionNrStatusRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.EINBestellungBestellungNrPositionBestellpositionNrStatusRequest);
    });
