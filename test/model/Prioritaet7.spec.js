...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Prioritaet7();
  });
  ...
  describe('Prioritaet7', function() {
    it('should create an instance of Prioritaet7', function() {
      // uncomment below and update the code to test Prioritaet7
      //var instance = new ProffixRestApiRequestSammlung.Prioritaet7();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Prioritaet7);
    });
