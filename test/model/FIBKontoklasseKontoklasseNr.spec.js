...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.FIBKontoklasseKontoklasseNr();
  });
  ...
  describe('FIBKontoklasseKontoklasseNr', function() {
    it('should create an instance of FIBKontoklasseKontoklasseNr', function() {
      // uncomment below and update the code to test FIBKontoklasseKontoklasseNr
      //var instance = new ProffixRestApiRequestSammlung.FIBKontoklasseKontoklasseNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.FIBKontoklasseKontoklasseNr);
    });

    it('should have the property kontoklasseNr (base name: "KontoklasseNr")', function() {
      // uncomment below and update the code to test the property kontoklasseNr
      //var instance = new ProffixRestApiRequestSammlung.FIBKontoklasseKontoklasseNr();
