...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LAGNotizartNotizartNr();
  });
  ...
  describe('LAGNotizartNotizartNr', function() {
    it('should create an instance of LAGNotizartNotizartNr', function() {
      // uncomment below and update the code to test LAGNotizartNotizartNr
      //var instance = new ProffixRestApiRequestSammlung.LAGNotizartNotizartNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LAGNotizartNotizartNr);
    });

    it('should have the property notizartNr (base name: "NotizartNr")', function() {
      // uncomment below and update the code to test the property notizartNr
      //var instance = new ProffixRestApiRequestSammlung.LAGNotizartNotizartNr();
