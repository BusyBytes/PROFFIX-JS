...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LAGArtikelArtikelNr();
  });
  ...
  describe('LAGArtikelArtikelNr', function() {
    it('should create an instance of LAGArtikelArtikelNr', function() {
      // uncomment below and update the code to test LAGArtikelArtikelNr
      //var instance = new ProffixRestApiRequestSammlung.LAGArtikelArtikelNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LAGArtikelArtikelNr);
    });
