...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LAGLieferantRequest();
  });
  ...
  describe('LAGLieferantRequest', function() {
    it('should create an instance of LAGLieferantRequest', function() {
      // uncomment below and update the code to test LAGLieferantRequest
      //var instance = new ProffixRestApiRequestSammlung.LAGLieferantRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LAGLieferantRequest);
    });
