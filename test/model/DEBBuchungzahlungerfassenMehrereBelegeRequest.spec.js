...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.DEBBuchungzahlungerfassenMehrereBelegeRequest();
  });
  ...
  describe('DEBBuchungzahlungerfassenMehrereBelegeRequest', function() {
    it('should create an instance of DEBBuchungzahlungerfassenMehrereBelegeRequest', function() {
      // uncomment below and update the code to test DEBBuchungzahlungerfassenMehrereBelegeRequest
      //var instance = new ProffixRestApiRequestSammlung.DEBBuchungzahlungerfassenMehrereBelegeRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.DEBBuchungzahlungerfassenMehrereBelegeRequest);
    });
