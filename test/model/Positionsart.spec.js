...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Positionsart();
  });
  ...
  describe('Positionsart', function() {
    it('should create an instance of Positionsart', function() {
      // uncomment below and update the code to test Positionsart
      //var instance = new ProffixRestApiRequestSammlung.Positionsart();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Positionsart);
    });
