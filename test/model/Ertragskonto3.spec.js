...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Ertragskonto3();
  });
  ...
  describe('Ertragskonto3', function() {
    it('should create an instance of Ertragskonto3', function() {
      // uncomment below and update the code to test Ertragskonto3
      //var instance = new ProffixRestApiRequestSammlung.Ertragskonto3();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Ertragskonto3);
    });
