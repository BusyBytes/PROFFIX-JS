...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.AUFDokumentstatusDokumentstatusNr();
  });
  ...
  describe('AUFDokumentstatusDokumentstatusNr', function() {
    it('should create an instance of AUFDokumentstatusDokumentstatusNr', function() {
      // uncomment below and update the code to test AUFDokumentstatusDokumentstatusNr
      //var instance = new ProffixRestApiRequestSammlung.AUFDokumentstatusDokumentstatusNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.AUFDokumentstatusDokumentstatusNr);
    });

    it('should have the property dokumentstatusNr (base name: "DokumentstatusNr")', function() {
      // uncomment below and update the code to test the property dokumentstatusNr
      //var instance = new ProffixRestApiRequestSammlung.AUFDokumentstatusDokumentstatusNr();
