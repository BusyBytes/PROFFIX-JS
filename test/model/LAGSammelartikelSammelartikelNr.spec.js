...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LAGSammelartikelSammelartikelNr();
  });
  ...
  describe('LAGSammelartikelSammelartikelNr', function() {
    it('should create an instance of LAGSammelartikelSammelartikelNr', function() {
      // uncomment below and update the code to test LAGSammelartikelSammelartikelNr
      //var instance = new ProffixRestApiRequestSammlung.LAGSammelartikelSammelartikelNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LAGSammelartikelSammelartikelNr);
    });

    it('should have the property sammelartikelNr (base name: "SammelartikelNr")', function() {
      // uncomment below and update the code to test the property sammelartikelNr
      //var instance = new ProffixRestApiRequestSammlung.LAGSammelartikelSammelartikelNr();
