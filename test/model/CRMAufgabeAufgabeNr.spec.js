...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.CRMAufgabeAufgabeNr();
  });
  ...
  describe('CRMAufgabeAufgabeNr', function() {
    it('should create an instance of CRMAufgabeAufgabeNr', function() {
      // uncomment below and update the code to test CRMAufgabeAufgabeNr
      //var instance = new ProffixRestApiRequestSammlung.CRMAufgabeAufgabeNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.CRMAufgabeAufgabeNr);
    });

    it('should have the property aufgabeNr (base name: "AufgabeNr")', function() {
      // uncomment below and update the code to test the property aufgabeNr
      //var instance = new ProffixRestApiRequestSammlung.CRMAufgabeAufgabeNr();
