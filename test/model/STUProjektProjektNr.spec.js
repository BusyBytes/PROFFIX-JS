...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.STUProjektProjektNr();
  });
  ...
  describe('STUProjektProjektNr', function() {
    it('should create an instance of STUProjektProjektNr', function() {
      // uncomment below and update the code to test STUProjektProjektNr
      //var instance = new ProffixRestApiRequestSammlung.STUProjektProjektNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.STUProjektProjektNr);
    });

    it('should have the property projektNr (base name: "ProjektNr")', function() {
      // uncomment below and update the code to test the property projektNr
      //var instance = new ProffixRestApiRequestSammlung.STUProjektProjektNr();
    ...
    it('should have the property teilleistungen (base name: "Teilleistungen")', function() {
      // uncomment below and update the code to test the property teilleistungen
      //var instance = new ProffixRestApiRequestSammlung.STUProjektProjektNr();
      //expect(instance).to.be();
    });
