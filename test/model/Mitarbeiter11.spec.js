...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Mitarbeiter11();
  });
  ...
  describe('Mitarbeiter11', function() {
    it('should create an instance of Mitarbeiter11', function() {
      // uncomment below and update the code to test Mitarbeiter11
      //var instance = new ProffixRestApiRequestSammlung.Mitarbeiter11();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Mitarbeiter11);
    });
