...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROWaehrungStandard();
  });
  ...
  describe('PROWaehrungStandard', function() {
    it('should create an instance of PROWaehrungStandard', function() {
      // uncomment below and update the code to test PROWaehrungStandard
      //var instance = new ProffixRestApiRequestSammlung.PROWaehrungStandard();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROWaehrungStandard);
    });
