...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.ADRAdressgruppeAdressgruppeNr();
  });
  ...
  describe('ADRAdressgruppeAdressgruppeNr', function() {
    it('should create an instance of ADRAdressgruppeAdressgruppeNr', function() {
      // uncomment below and update the code to test ADRAdressgruppeAdressgruppeNr
      //var instance = new ProffixRestApiRequestSammlung.ADRAdressgruppeAdressgruppeNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.ADRAdressgruppeAdressgruppeNr);
    });
