...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LOHZivilstandZivilstandNr();
  });
  ...
  describe('LOHZivilstandZivilstandNr', function() {
    it('should create an instance of LOHZivilstandZivilstandNr', function() {
      // uncomment below and update the code to test LOHZivilstandZivilstandNr
      //var instance = new ProffixRestApiRequestSammlung.LOHZivilstandZivilstandNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LOHZivilstandZivilstandNr);
    });

    it('should have the property zivilstandNr (base name: "ZivilstandNr")', function() {
      // uncomment below and update the code to test the property zivilstandNr
      //var instance = new ProffixRestApiRequestSammlung.LOHZivilstandZivilstandNr();
