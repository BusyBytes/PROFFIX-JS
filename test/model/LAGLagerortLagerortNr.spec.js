...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LAGLagerortLagerortNr();
  });
  ...
  describe('LAGLagerortLagerortNr', function() {
    it('should create an instance of LAGLagerortLagerortNr', function() {
      // uncomment below and update the code to test LAGLagerortLagerortNr
      //var instance = new ProffixRestApiRequestSammlung.LAGLagerortLagerortNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LAGLagerortLagerortNr);
    });

    it('should have the property lagerortNr (base name: "LagerortNr")', function() {
      // uncomment below and update the code to test the property lagerortNr
      //var instance = new ProffixRestApiRequestSammlung.LAGLagerortLagerortNr();
