...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.STUTeilleistungstypTeilleistungstypNr();
  });
  ...
  describe('STUTeilleistungstypTeilleistungstypNr', function() {
    it('should create an instance of STUTeilleistungstypTeilleistungstypNr', function() {
      // uncomment below and update the code to test STUTeilleistungstypTeilleistungstypNr
      //var instance = new ProffixRestApiRequestSammlung.STUTeilleistungstypTeilleistungstypNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.STUTeilleistungstypTeilleistungstypNr);
    });
