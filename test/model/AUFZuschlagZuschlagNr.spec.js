...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.AUFZuschlagZuschlagNr();
  });
  ...
  describe('AUFZuschlagZuschlagNr', function() {
    it('should create an instance of AUFZuschlagZuschlagNr', function() {
      // uncomment below and update the code to test AUFZuschlagZuschlagNr
      //var instance = new ProffixRestApiRequestSammlung.AUFZuschlagZuschlagNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.AUFZuschlagZuschlagNr);
    });

    it('should have the property zuschlagNr (base name: "ZuschlagNr")', function() {
      // uncomment below and update the code to test the property zuschlagNr
      //var instance = new ProffixRestApiRequestSammlung.AUFZuschlagZuschlagNr();
