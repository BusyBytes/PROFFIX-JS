...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Buchungen6();
  });
  ...
  describe('Buchungen6', function() {
    it('should create an instance of Buchungen6', function() {
      // uncomment below and update the code to test Buchungen6
      //var instance = new ProffixRestApiRequestSammlung.Buchungen6();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Buchungen6);
    });
