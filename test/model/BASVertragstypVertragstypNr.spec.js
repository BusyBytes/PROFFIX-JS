...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.BASVertragstypVertragstypNr();
  });
  ...
  describe('BASVertragstypVertragstypNr', function() {
    it('should create an instance of BASVertragstypVertragstypNr', function() {
      // uncomment below and update the code to test BASVertragstypVertragstypNr
      //var instance = new ProffixRestApiRequestSammlung.BASVertragstypVertragstypNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.BASVertragstypVertragstypNr);
    });
