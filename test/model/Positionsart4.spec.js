...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Positionsart4();
  });
  ...
  describe('Positionsart4', function() {
    it('should create an instance of Positionsart4', function() {
      // uncomment below and update the code to test Positionsart4
      //var instance = new ProffixRestApiRequestSammlung.Positionsart4();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Positionsart4);
    });
