...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Positionen7();
  });
  ...
  describe('Positionen7', function() {
    it('should create an instance of Positionen7', function() {
      // uncomment below and update the code to test Positionen7
      //var instance = new ProffixRestApiRequestSammlung.Positionen7();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Positionen7);
    });

    it('should have the property abBetrag (base name: "AbBetrag")', function() {
      // uncomment below and update the code to test the property abBetrag
      //var instance = new ProffixRestApiRequestSammlung.Positionen7();
