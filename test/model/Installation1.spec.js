...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Installation1();
  });
  ...
  describe('Installation1', function() {
    it('should create an instance of Installation1', function() {
      // uncomment below and update the code to test Installation1
      //var instance = new ProffixRestApiRequestSammlung.Installation1();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Installation1);
    });
