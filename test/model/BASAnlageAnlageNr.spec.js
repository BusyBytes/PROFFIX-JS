...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.BASAnlageAnlageNr();
  });
  ...
  describe('BASAnlageAnlageNr', function() {
    it('should create an instance of BASAnlageAnlageNr', function() {
      // uncomment below and update the code to test BASAnlageAnlageNr
      //var instance = new ProffixRestApiRequestSammlung.BASAnlageAnlageNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.BASAnlageAnlageNr);
    });

    it('should have the property anlageNr (base name: "AnlageNr")', function() {
      // uncomment below and update the code to test the property anlageNr
      //var instance = new ProffixRestApiRequestSammlung.BASAnlageAnlageNr();
