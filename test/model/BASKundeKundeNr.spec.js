...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.BASKundeKundeNr();
  });
  ...
  describe('BASKundeKundeNr', function() {
    it('should create an instance of BASKundeKundeNr', function() {
      // uncomment below and update the code to test BASKundeKundeNr
      //var instance = new ProffixRestApiRequestSammlung.BASKundeKundeNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.BASKundeKundeNr);
    });
