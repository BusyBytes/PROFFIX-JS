...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Ertragskonto9();
  });
  ...
  describe('Ertragskonto9', function() {
    it('should create an instance of Ertragskonto9', function() {
      // uncomment below and update the code to test Ertragskonto9
      //var instance = new ProffixRestApiRequestSammlung.Ertragskonto9();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Ertragskonto9);
    });
