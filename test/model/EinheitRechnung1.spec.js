...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.EinheitRechnung1();
  });
  ...
  describe('EinheitRechnung1', function() {
    it('should create an instance of EinheitRechnung1', function() {
      // uncomment below and update the code to test EinheitRechnung1
      //var instance = new ProffixRestApiRequestSammlung.EinheitRechnung1();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.EinheitRechnung1);
    });
