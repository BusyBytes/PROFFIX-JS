...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LAGChargeChargeNr();
  });
  ...
  describe('LAGChargeChargeNr', function() {
    it('should create an instance of LAGChargeChargeNr', function() {
      // uncomment below and update the code to test LAGChargeChargeNr
      //var instance = new ProffixRestApiRequestSammlung.LAGChargeChargeNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LAGChargeChargeNr);
    });
