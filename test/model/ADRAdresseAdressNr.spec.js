...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.ADRAdresseAdressNr();
  });
  ...
  describe('ADRAdresseAdressNr', function() {
    it('should create an instance of ADRAdresseAdressNr', function() {
      // uncomment below and update the code to test ADRAdresseAdressNr
      //var instance = new ProffixRestApiRequestSammlung.ADRAdresseAdressNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.ADRAdresseAdressNr);
    });
