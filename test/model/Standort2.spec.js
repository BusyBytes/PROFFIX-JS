...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Standort2();
  });
  ...
  describe('Standort2', function() {
    it('should create an instance of Standort2', function() {
      // uncomment below and update the code to test Standort2
      //var instance = new ProffixRestApiRequestSammlung.Standort2();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Standort2);
    });
