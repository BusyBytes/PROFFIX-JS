...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.DEBBuchungzahlungerfassenMehrereBelegeundRechnungssaldoRequest();
  });
  ...
  describe('DEBBuchungzahlungerfassenMehrereBelegeundRechnungssaldoRequest', function() {
    it('should create an instance of DEBBuchungzahlungerfassenMehrereBelegeundRechnungssaldoRequest', function() {
      // uncomment below and update the code to test DEBBuchungzahlungerfassenMehrereBelegeundRechnungssaldoRequest
      //var instance = new ProffixRestApiRequestSammlung.DEBBuchungzahlungerfassenMehrereBelegeundRechnungssaldoRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.DEBBuchungzahlungerfassenMehrereBelegeundRechnungssaldoRequest);
    });
