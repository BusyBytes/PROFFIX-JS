...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LOHAbteilungAbteilungNr();
  });
  ...
  describe('LOHAbteilungAbteilungNr', function() {
    it('should create an instance of LOHAbteilungAbteilungNr', function() {
      // uncomment below and update the code to test LOHAbteilungAbteilungNr
      //var instance = new ProffixRestApiRequestSammlung.LOHAbteilungAbteilungNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LOHAbteilungAbteilungNr);
    });

    it('should have the property abteilungNr (base name: "AbteilungNr")', function() {
      // uncomment below and update the code to test the property abteilungNr
      //var instance = new ProffixRestApiRequestSammlung.LOHAbteilungAbteilungNr();
