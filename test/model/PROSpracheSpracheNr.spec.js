...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROSpracheSpracheNr();
  });
  ...
  describe('PROSpracheSpracheNr', function() {
    it('should create an instance of PROSpracheSpracheNr', function() {
      // uncomment below and update the code to test PROSpracheSpracheNr
      //var instance = new ProffixRestApiRequestSammlung.PROSpracheSpracheNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROSpracheSpracheNr);
    });
