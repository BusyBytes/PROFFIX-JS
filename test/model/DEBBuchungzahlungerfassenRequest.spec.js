...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.DEBBuchungzahlungerfassenRequest();
  });
  ...
  describe('DEBBuchungzahlungerfassenRequest', function() {
    it('should create an instance of DEBBuchungzahlungerfassenRequest', function() {
      // uncomment below and update the code to test DEBBuchungzahlungerfassenRequest
      //var instance = new ProffixRestApiRequestSammlung.DEBBuchungzahlungerfassenRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.DEBBuchungzahlungerfassenRequest);
    });
