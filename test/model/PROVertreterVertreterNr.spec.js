...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROVertreterVertreterNr();
  });
  ...
  describe('PROVertreterVertreterNr', function() {
    it('should create an instance of PROVertreterVertreterNr', function() {
      // uncomment below and update the code to test PROVertreterVertreterNr
      //var instance = new ProffixRestApiRequestSammlung.PROVertreterVertreterNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROVertreterVertreterNr);
    });
