...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.AUFDokumentDokumentNrentsperrenRequest();
  });
  ...
  describe('AUFDokumentDokumentNrentsperrenRequest', function() {
    it('should create an instance of AUFDokumentDokumentNrentsperrenRequest', function() {
      // uncomment below and update the code to test AUFDokumentDokumentNrentsperrenRequest
      //var instance = new ProffixRestApiRequestSammlung.AUFDokumentDokumentNrentsperrenRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.AUFDokumentDokumentNrentsperrenRequest);
    });
