...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.SRVServiceauftragRequest();
  });
  ...
  describe('SRVServiceauftragRequest', function() {
    it('should create an instance of SRVServiceauftragRequest', function() {
      // uncomment below and update the code to test SRVServiceauftragRequest
      //var instance = new ProffixRestApiRequestSammlung.SRVServiceauftragRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.SRVServiceauftragRequest);
    });
