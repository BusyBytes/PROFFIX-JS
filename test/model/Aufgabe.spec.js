...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Aufgabe();
  });
  ...
  describe('Aufgabe', function() {
    it('should create an instance of Aufgabe', function() {
      // uncomment below and update the code to test Aufgabe
      //var instance = new ProffixRestApiRequestSammlung.Aufgabe();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Aufgabe);
    });
