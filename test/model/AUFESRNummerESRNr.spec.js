...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.AUFESRNummerESRNr();
  });
  ...
  describe('AUFESRNummerESRNr', function() {
    it('should create an instance of AUFESRNummerESRNr', function() {
      // uncomment below and update the code to test AUFESRNummerESRNr
      //var instance = new ProffixRestApiRequestSammlung.AUFESRNummerESRNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.AUFESRNummerESRNr);
    });
