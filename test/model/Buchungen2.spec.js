...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Buchungen2();
  });
  ...
  describe('Buchungen2', function() {
    it('should create an instance of Buchungen2', function() {
      // uncomment below and update the code to test Buchungen2
      //var instance = new ProffixRestApiRequestSammlung.Buchungen2();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Buchungen2);
    });
