...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Kunde6();
  });
  ...
  describe('Kunde6', function() {
    it('should create an instance of Kunde6', function() {
      // uncomment below and update the code to test Kunde6
      //var instance = new ProffixRestApiRequestSammlung.Kunde6();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Kunde6);
    });
