...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Adressgruppen2();
  });
  ...
  describe('Adressgruppen2', function() {
    it('should create an instance of Adressgruppen2', function() {
      // uncomment below and update the code to test Adressgruppen2
      //var instance = new ProffixRestApiRequestSammlung.Adressgruppen2();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Adressgruppen2);
    });
