...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROBuchungstext();
  });
  ...
  describe('PROBuchungstext', function() {
    it('should create an instance of PROBuchungstext', function() {
      // uncomment below and update the code to test PROBuchungstext
      //var instance = new ProffixRestApiRequestSammlung.PROBuchungstext();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROBuchungstext);
    });
