...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Buchungen3();
  });
  ...
  describe('Buchungen3', function() {
    it('should create an instance of Buchungen3', function() {
      // uncomment below and update the code to test Buchungen3
      //var instance = new ProffixRestApiRequestSammlung.Buchungen3();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Buchungen3);
    });
