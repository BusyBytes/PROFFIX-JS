...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROFunktionFunktionNr();
  });
  ...
  describe('PROFunktionFunktionNr', function() {
    it('should create an instance of PROFunktionFunktionNr', function() {
      // uncomment below and update the code to test PROFunktionFunktionNr
      //var instance = new ProffixRestApiRequestSammlung.PROFunktionFunktionNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROFunktionFunktionNr);
    });

    it('should have the property funktionNr (base name: "FunktionNr")', function() {
      // uncomment below and update the code to test the property funktionNr
      //var instance = new ProffixRestApiRequestSammlung.PROFunktionFunktionNr();
