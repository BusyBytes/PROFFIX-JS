...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.DebitorenWaehrung2();
  });
  ...
  describe('DebitorenWaehrung2', function() {
    it('should create an instance of DebitorenWaehrung2', function() {
      // uncomment below and update the code to test DebitorenWaehrung2
      //var instance = new ProffixRestApiRequestSammlung.DebitorenWaehrung2();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.DebitorenWaehrung2);
    });
