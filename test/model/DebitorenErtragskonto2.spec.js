...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.DebitorenErtragskonto2();
  });
  ...
  describe('DebitorenErtragskonto2', function() {
    it('should create an instance of DebitorenErtragskonto2', function() {
      // uncomment below and update the code to test DebitorenErtragskonto2
      //var instance = new ProffixRestApiRequestSammlung.DebitorenErtragskonto2();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.DebitorenErtragskonto2);
    });
