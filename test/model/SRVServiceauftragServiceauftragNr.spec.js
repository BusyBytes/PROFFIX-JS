...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.SRVServiceauftragServiceauftragNr();
  });
  ...
  describe('SRVServiceauftragServiceauftragNr', function() {
    it('should create an instance of SRVServiceauftragServiceauftragNr', function() {
      // uncomment below and update the code to test SRVServiceauftragServiceauftragNr
      //var instance = new ProffixRestApiRequestSammlung.SRVServiceauftragServiceauftragNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.SRVServiceauftragServiceauftragNr);
    });

    it('should have the property serviceauftragNr (base name: "ServiceauftragNr")', function() {
      // uncomment below and update the code to test the property serviceauftragNr
      //var instance = new ProffixRestApiRequestSammlung.SRVServiceauftragServiceauftragNr();
    ...
    it('should have the property serviceart (base name: "Serviceart")', function() {
      // uncomment below and update the code to test the property serviceart
      //var instance = new ProffixRestApiRequestSammlung.SRVServiceauftragServiceauftragNr();
      //expect(instance).to.be();
    });

    it('should have the property kontaktperson (base name: "Kontaktperson")', function() {
      // uncomment below and update the code to test the property kontaktperson
      //var instance = new ProffixRestApiRequestSammlung.SRVServiceauftragServiceauftragNr();
      //expect(instance).to.be();
    });

    it('should have the property kontaktpersonTel (base name: "KontaktpersonTel")', function() {
      // uncomment below and update the code to test the property kontaktpersonTel
      //var instance = new ProffixRestApiRequestSammlung.SRVServiceauftragServiceauftragNr();
      //expect(instance).to.be();
    });

    it('should have the property kontaktExtern (base name: "KontaktExtern")', function() {
      // uncomment below and update the code to test the property kontaktExtern
      //var instance = new ProffixRestApiRequestSammlung.SRVServiceauftragServiceauftragNr();
      //expect(instance).to.be();
    });
    ...
    it('should have the property disponent (base name: "Disponent")', function() {
      // uncomment below and update the code to test the property disponent
      //var instance = new ProffixRestApiRequestSammlung.SRVServiceauftragServiceauftragNr();
      //expect(instance).to.be();
    });
