...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Vertragstyp2();
  });
  ...
  describe('Vertragstyp2', function() {
    it('should create an instance of Vertragstyp2', function() {
      // uncomment below and update the code to test Vertragstyp2
      //var instance = new ProffixRestApiRequestSammlung.Vertragstyp2();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Vertragstyp2);
    });

    it('should have the property vertragstypNr (base name: "VertragstypNr")', function() {
      // uncomment below and update the code to test the property vertragstypNr
      //var instance = new ProffixRestApiRequestSammlung.Vertragstyp2();
