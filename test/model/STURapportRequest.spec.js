...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.STURapportRequest();
  });
  ...
  describe('STURapportRequest', function() {
    it('should create an instance of STURapportRequest', function() {
      // uncomment below and update the code to test STURapportRequest
      //var instance = new ProffixRestApiRequestSammlung.STURapportRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.STURapportRequest);
    });
