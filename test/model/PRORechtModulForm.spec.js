...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PRORechtModulForm();
  });
  ...
  describe('PRORechtModulForm', function() {
    it('should create an instance of PRORechtModulForm', function() {
      // uncomment below and update the code to test PRORechtModulForm
      //var instance = new ProffixRestApiRequestSammlung.PRORechtModulForm();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PRORechtModulForm);
    });
