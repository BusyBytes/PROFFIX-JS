...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROAuftragRequest();
  });
  ...
  describe('PROAuftragRequest', function() {
    it('should create an instance of PROAuftragRequest', function() {
      // uncomment below and update the code to test PROAuftragRequest
      //var instance = new ProffixRestApiRequestSammlung.PROAuftragRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROAuftragRequest);
    });
    ...
    it('should have the property laufend (base name: "Laufend")', function() {
      // uncomment below and update the code to test the property laufend
      //var instance = new ProffixRestApiRequestSammlung.PROAuftragRequest();
      //expect(instance).to.be();
    });
