...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Planobjektgruppe();
  });
  ...
  describe('Planobjektgruppe', function() {
    it('should create an instance of Planobjektgruppe', function() {
      // uncomment below and update the code to test Planobjektgruppe
      //var instance = new ProffixRestApiRequestSammlung.Planobjektgruppe();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Planobjektgruppe);
    });
