...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Positionen9();
  });
  ...
  describe('Positionen9', function() {
    it('should create an instance of Positionen9', function() {
      // uncomment below and update the code to test Positionen9
      //var instance = new ProffixRestApiRequestSammlung.Positionen9();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Positionen9);
    });
