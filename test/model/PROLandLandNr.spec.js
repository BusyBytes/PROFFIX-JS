...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROLandLandNr();
  });
  ...
  describe('PROLandLandNr', function() {
    it('should create an instance of PROLandLandNr', function() {
      // uncomment below and update the code to test PROLandLandNr
      //var instance = new ProffixRestApiRequestSammlung.PROLandLandNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROLandLandNr);
    });
