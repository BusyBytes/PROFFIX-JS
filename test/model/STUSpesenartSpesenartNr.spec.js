...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.STUSpesenartSpesenartNr();
  });
  ...
  describe('STUSpesenartSpesenartNr', function() {
    it('should create an instance of STUSpesenartSpesenartNr', function() {
      // uncomment below and update the code to test STUSpesenartSpesenartNr
      //var instance = new ProffixRestApiRequestSammlung.STUSpesenartSpesenartNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.STUSpesenartSpesenartNr);
    });

    it('should have the property spesenartNr (base name: "SpesenartNr")', function() {
      // uncomment below and update the code to test the property spesenartNr
      //var instance = new ProffixRestApiRequestSammlung.STUSpesenartSpesenartNr();
    ...
    it('should have the property textZwang (base name: "TextZwang")', function() {
      // uncomment below and update the code to test the property textZwang
      //var instance = new ProffixRestApiRequestSammlung.STUSpesenartSpesenartNr();
      //expect(instance).to.be();
    });
