...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LOHUnfallzusatzversicherungscodeUnfallzusatzversicherungscodeNr();
  });
  ...
  describe('LOHUnfallzusatzversicherungscodeUnfallzusatzversicherungscodeNr', function() {
    it('should create an instance of LOHUnfallzusatzversicherungscodeUnfallzusatzversicherungscodeNr', function() {
      // uncomment below and update the code to test LOHUnfallzusatzversicherungscodeUnfallzusatzversicherungscodeNr
      //var instance = new ProffixRestApiRequestSammlung.LOHUnfallzusatzversicherungscodeUnfallzusatzversicherungscodeNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LOHUnfallzusatzversicherungscodeUnfallzusatzversicherungscodeNr);
    });

    it('should have the property unfallzusatzversicherungscodeNr (base name: "UnfallzusatzversicherungscodeNr")', function() {
      // uncomment below and update the code to test the property unfallzusatzversicherungscodeNr
      //var instance = new ProffixRestApiRequestSammlung.LOHUnfallzusatzversicherungscodeUnfallzusatzversicherungscodeNr();
