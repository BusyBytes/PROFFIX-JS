...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PRORegionRegionNr();
  });
  ...
  describe('PRORegionRegionNr', function() {
    it('should create an instance of PRORegionRegionNr', function() {
      // uncomment below and update the code to test PRORegionRegionNr
      //var instance = new ProffixRestApiRequestSammlung.PRORegionRegionNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PRORegionRegionNr);
    });
