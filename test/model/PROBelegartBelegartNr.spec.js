...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROBelegartBelegartNr();
  });
  ...
  describe('PROBelegartBelegartNr', function() {
    it('should create an instance of PROBelegartBelegartNr', function() {
      // uncomment below and update the code to test PROBelegartBelegartNr
      //var instance = new ProffixRestApiRequestSammlung.PROBelegartBelegartNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROBelegartBelegartNr);
    });
