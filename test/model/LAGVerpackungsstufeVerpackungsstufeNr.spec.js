...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LAGVerpackungsstufeVerpackungsstufeNr();
  });
  ...
  describe('LAGVerpackungsstufeVerpackungsstufeNr', function() {
    it('should create an instance of LAGVerpackungsstufeVerpackungsstufeNr', function() {
      // uncomment below and update the code to test LAGVerpackungsstufeVerpackungsstufeNr
      //var instance = new ProffixRestApiRequestSammlung.LAGVerpackungsstufeVerpackungsstufeNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LAGVerpackungsstufeVerpackungsstufeNr);
    });

    it('should have the property verpackungsstufeNr (base name: "VerpackungsstufeNr")', function() {
      // uncomment below and update the code to test the property verpackungsstufeNr
      //var instance = new ProffixRestApiRequestSammlung.LAGVerpackungsstufeVerpackungsstufeNr();
    ...
    it('should have the property indikator (base name: "Indikator")', function() {
      // uncomment below and update the code to test the property indikator
      //var instance = new ProffixRestApiRequestSammlung.LAGVerpackungsstufeVerpackungsstufeNr();
      //expect(instance).to.be();
    });
