...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LAGNotizNotizNr();
  });
  ...
  describe('LAGNotizNotizNr', function() {
    it('should create an instance of LAGNotizNotizNr', function() {
      // uncomment below and update the code to test LAGNotizNotizNr
      //var instance = new ProffixRestApiRequestSammlung.LAGNotizNotizNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LAGNotizNotizNr);
    });
