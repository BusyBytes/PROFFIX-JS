...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROEinstellungModulSection();
  });
  ...
  describe('PROEinstellungModulSection', function() {
    it('should create an instance of PROEinstellungModulSection', function() {
      // uncomment below and update the code to test PROEinstellungModulSection
      //var instance = new ProffixRestApiRequestSammlung.PROEinstellungModulSection();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROEinstellungModulSection);
    });
    ...
    it('should have the property einstellung (base name: "Einstellung")', function() {
      // uncomment below and update the code to test the property einstellung
      //var instance = new ProffixRestApiRequestSammlung.PROEinstellungModulSection();
      //expect(instance).to.be();
    });
