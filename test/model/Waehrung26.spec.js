...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Waehrung26();
  });
  ...
  describe('Waehrung26', function() {
    it('should create an instance of Waehrung26', function() {
      // uncomment below and update the code to test Waehrung26
      //var instance = new ProffixRestApiRequestSammlung.Waehrung26();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Waehrung26);
    });
