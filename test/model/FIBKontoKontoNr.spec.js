...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.FIBKontoKontoNr();
  });
  ...
  describe('FIBKontoKontoNr', function() {
    it('should create an instance of FIBKontoKontoNr', function() {
      // uncomment below and update the code to test FIBKontoKontoNr
      //var instance = new ProffixRestApiRequestSammlung.FIBKontoKontoNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.FIBKontoKontoNr);
    });
