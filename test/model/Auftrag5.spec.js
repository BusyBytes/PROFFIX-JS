...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Auftrag5();
  });
  ...
  describe('Auftrag5', function() {
    it('should create an instance of Auftrag5', function() {
      // uncomment below and update the code to test Auftrag5
      //var instance = new ProffixRestApiRequestSammlung.Auftrag5();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Auftrag5);
    });
