...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PRODatenbankkeyPassword();
  });
  ...
  describe('PRODatenbankkeyPassword', function() {
    it('should create an instance of PRODatenbankkeyPassword', function() {
      // uncomment below and update the code to test PRODatenbankkeyPassword
      //var instance = new ProffixRestApiRequestSammlung.PRODatenbankkeyPassword();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PRODatenbankkeyPassword);
    });
