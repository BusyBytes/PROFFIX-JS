...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROAuftragAuftragNr();
  });
  ...
  describe('PROAuftragAuftragNr', function() {
    it('should create an instance of PROAuftragAuftragNr', function() {
      // uncomment below and update the code to test PROAuftragAuftragNr
      //var instance = new ProffixRestApiRequestSammlung.PROAuftragAuftragNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROAuftragAuftragNr);
    });
