...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Buchungen1();
  });
  ...
  describe('Buchungen1', function() {
    it('should create an instance of Buchungen1', function() {
      // uncomment below and update the code to test Buchungen1
      //var instance = new ProffixRestApiRequestSammlung.Buchungen1();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Buchungen1);
    });
