...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.DebitorenSteuercode2();
  });
  ...
  describe('DebitorenSteuercode2', function() {
    it('should create an instance of DebitorenSteuercode2', function() {
      // uncomment below and update the code to test DebitorenSteuercode2
      //var instance = new ProffixRestApiRequestSammlung.DebitorenSteuercode2();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.DebitorenSteuercode2);
    });
