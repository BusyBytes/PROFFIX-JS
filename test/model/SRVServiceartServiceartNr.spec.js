...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.SRVServiceartServiceartNr();
  });
  ...
  describe('SRVServiceartServiceartNr', function() {
    it('should create an instance of SRVServiceartServiceartNr', function() {
      // uncomment below and update the code to test SRVServiceartServiceartNr
      //var instance = new ProffixRestApiRequestSammlung.SRVServiceartServiceartNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.SRVServiceartServiceartNr);
    });

    it('should have the property serviceartNr (base name: "ServiceartNr")', function() {
      // uncomment below and update the code to test the property serviceartNr
      //var instance = new ProffixRestApiRequestSammlung.SRVServiceartServiceartNr();
    ...
    it('should have the property beschrieb (base name: "Beschrieb")', function() {
      // uncomment below and update the code to test the property beschrieb
      //var instance = new ProffixRestApiRequestSammlung.SRVServiceartServiceartNr();
      //expect(instance).to.be();
    });
