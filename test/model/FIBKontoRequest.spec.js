...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.FIBKontoRequest();
  });
  ...
  describe('FIBKontoRequest', function() {
    it('should create an instance of FIBKontoRequest', function() {
      // uncomment below and update the code to test FIBKontoRequest
      //var instance = new ProffixRestApiRequestSammlung.FIBKontoRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.FIBKontoRequest);
    });
