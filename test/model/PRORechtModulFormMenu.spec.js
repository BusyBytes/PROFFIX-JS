...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PRORechtModulFormMenu();
  });
  ...
  describe('PRORechtModulFormMenu', function() {
    it('should create an instance of PRORechtModulFormMenu', function() {
      // uncomment below and update the code to test PRORechtModulFormMenu
      //var instance = new ProffixRestApiRequestSammlung.PRORechtModulFormMenu();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PRORechtModulFormMenu);
    });
