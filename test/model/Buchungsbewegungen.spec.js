...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Buchungsbewegungen();
  });
  ...
  describe('Buchungsbewegungen', function() {
    it('should create an instance of Buchungsbewegungen', function() {
      // uncomment below and update the code to test Buchungsbewegungen
      //var instance = new ProffixRestApiRequestSammlung.Buchungsbewegungen();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Buchungsbewegungen);
    });
