...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Option();
  });
  ...
  describe('Option', function() {
    it('should create an instance of Option', function() {
      ...
      //var instance = new ProffixRestApiRequestSammlung.Option();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Option);
    });
