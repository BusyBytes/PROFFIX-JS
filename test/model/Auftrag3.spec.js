...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Auftrag3();
  });
  ...
  describe('Auftrag3', function() {
    it('should create an instance of Auftrag3', function() {
      // uncomment below and update the code to test Auftrag3
      //var instance = new ProffixRestApiRequestSammlung.Auftrag3();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Auftrag3);
    });
