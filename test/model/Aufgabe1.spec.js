...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Aufgabe1();
  });
  ...
  describe('Aufgabe1', function() {
    it('should create an instance of Aufgabe1', function() {
      // uncomment below and update the code to test Aufgabe1
      //var instance = new ProffixRestApiRequestSammlung.Aufgabe1();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Aufgabe1);
    });
