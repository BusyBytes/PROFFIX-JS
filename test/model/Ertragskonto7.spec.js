...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Ertragskonto7();
  });
  ...
  describe('Ertragskonto7', function() {
    it('should create an instance of Ertragskonto7', function() {
      // uncomment below and update the code to test Ertragskonto7
      //var instance = new ProffixRestApiRequestSammlung.Ertragskonto7();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Ertragskonto7);
    });
