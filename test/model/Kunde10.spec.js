...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Kunde10();
  });
  ...
  describe('Kunde10', function() {
    it('should create an instance of Kunde10', function() {
      // uncomment below and update the code to test Kunde10
      //var instance = new ProffixRestApiRequestSammlung.Kunde10();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Kunde10);
    });

    it('should have the property kundeNr (base name: "KundeNr")', function() {
      // uncomment below and update the code to test the property kundeNr
      //var instance = new ProffixRestApiRequestSammlung.Kunde10();
