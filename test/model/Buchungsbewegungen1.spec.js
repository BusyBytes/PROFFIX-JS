...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Buchungsbewegungen1();
  });
  ...
  describe('Buchungsbewegungen1', function() {
    it('should create an instance of Buchungsbewegungen1', function() {
      // uncomment below and update the code to test Buchungsbewegungen1
      //var instance = new ProffixRestApiRequestSammlung.Buchungsbewegungen1();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Buchungsbewegungen1);
    });
