...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Adresse31();
  });
  ...
  describe('Adresse31', function() {
    it('should create an instance of Adresse31', function() {
      // uncomment below and update the code to test Adresse31
      //var instance = new ProffixRestApiRequestSammlung.Adresse31();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Adresse31);
    });
