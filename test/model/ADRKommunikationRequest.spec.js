...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.ADRKommunikationRequest();
  });
  ...
  describe('ADRKommunikationRequest', function() {
    it('should create an instance of ADRKommunikationRequest', function() {
      // uncomment below and update the code to test ADRKommunikationRequest
      //var instance = new ProffixRestApiRequestSammlung.ADRKommunikationRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.ADRKommunikationRequest);
    });

    it('should have the property kommunikationNr (base name: "KommunikationNr")', function() {
      // uncomment below and update the code to test the property kommunikationNr
      //var instance = new ProffixRestApiRequestSammlung.ADRKommunikationRequest();
    ...
    it('should have the property kommunikationsangabe (base name: "Kommunikationsangabe")', function() {
      // uncomment below and update the code to test the property kommunikationsangabe
      //var instance = new ProffixRestApiRequestSammlung.ADRKommunikationRequest();
      //expect(instance).to.be();
    });
