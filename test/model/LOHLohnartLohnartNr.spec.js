...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LOHLohnartLohnartNr();
  });
  ...
  describe('LOHLohnartLohnartNr', function() {
    it('should create an instance of LOHLohnartLohnartNr', function() {
      // uncomment below and update the code to test LOHLohnartLohnartNr
      //var instance = new ProffixRestApiRequestSammlung.LOHLohnartLohnartNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LOHLohnartLohnartNr);
    });

    it('should have the property lohnartNr (base name: "LohnartNr")', function() {
      // uncomment below and update the code to test the property lohnartNr
      //var instance = new ProffixRestApiRequestSammlung.LOHLohnartLohnartNr();
