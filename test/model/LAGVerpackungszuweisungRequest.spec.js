...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LAGVerpackungszuweisungRequest();
  });
  ...
  describe('LAGVerpackungszuweisungRequest', function() {
    it('should create an instance of LAGVerpackungszuweisungRequest', function() {
      // uncomment below and update the code to test LAGVerpackungszuweisungRequest
      //var instance = new ProffixRestApiRequestSammlung.LAGVerpackungszuweisungRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LAGVerpackungszuweisungRequest);
    });
