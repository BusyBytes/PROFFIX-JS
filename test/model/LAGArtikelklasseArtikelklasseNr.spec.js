...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LAGArtikelklasseArtikelklasseNr();
  });
  ...
  describe('LAGArtikelklasseArtikelklasseNr', function() {
    it('should create an instance of LAGArtikelklasseArtikelklasseNr', function() {
      // uncomment below and update the code to test LAGArtikelklasseArtikelklasseNr
      //var instance = new ProffixRestApiRequestSammlung.LAGArtikelklasseArtikelklasseNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LAGArtikelklasseArtikelklasseNr);
    });

    it('should have the property artikelklasseNr (base name: "ArtikelklasseNr")', function() {
      // uncomment below and update the code to test the property artikelklasseNr
      //var instance = new ProffixRestApiRequestSammlung.LAGArtikelklasseArtikelklasseNr();
    ...
    it('should have the property gs1Lebensmittel (base name: "Gs1Lebensmittel")', function() {
      // uncomment below and update the code to test the property gs1Lebensmittel
      //var instance = new ProffixRestApiRequestSammlung.LAGArtikelklasseArtikelklasseNr();
      //expect(instance).to.be();
    });
