...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROZusatztabelleZusatztabellennameSchlssel();
  });
  ...
  describe('PROZusatztabelleZusatztabellennameSchlssel', function() {
    it('should create an instance of PROZusatztabelleZusatztabellennameSchlssel', function() {
      // uncomment below and update the code to test PROZusatztabelleZusatztabellennameSchlssel
      //var instance = new ProffixRestApiRequestSammlung.PROZusatztabelleZusatztabellennameSchlssel();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROZusatztabelleZusatztabellennameSchlssel);
    });
