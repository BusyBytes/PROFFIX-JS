...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.ADRNotizartNotizartNr();
  });
  ...
  describe('ADRNotizartNotizartNr', function() {
    it('should create an instance of ADRNotizartNotizartNr', function() {
      // uncomment below and update the code to test ADRNotizartNotizartNr
      //var instance = new ProffixRestApiRequestSammlung.ADRNotizartNotizartNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.ADRNotizartNotizartNr);
    });
