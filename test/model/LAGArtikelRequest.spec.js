...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LAGArtikelRequest();
  });
  ...
  describe('LAGArtikelRequest', function() {
    it('should create an instance of LAGArtikelRequest', function() {
      // uncomment below and update the code to test LAGArtikelRequest
      //var instance = new ProffixRestApiRequestSammlung.LAGArtikelRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LAGArtikelRequest);
    });
