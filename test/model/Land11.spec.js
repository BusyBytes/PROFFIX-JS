...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Land11();
  });
  ...
  describe('Land11', function() {
    it('should create an instance of Land11', function() {
      // uncomment below and update the code to test Land11
      //var instance = new ProffixRestApiRequestSammlung.Land11();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Land11);
    });

    it('should have the property landNr (base name: "LandNr")', function() {
      // uncomment below and update the code to test the property landNr
      //var instance = new ProffixRestApiRequestSammlung.Land11();
    ...
    it('should have the property vorwahl (base name: "Vorwahl")', function() {
      // uncomment below and update the code to test the property vorwahl
      //var instance = new ProffixRestApiRequestSammlung.Land11();
      //expect(instance).to.be();
    });
    ...
    it('should have the property sADCode (base name: "SADCode")', function() {
      // uncomment below and update the code to test the property sADCode
      //var instance = new ProffixRestApiRequestSammlung.Land11();
      //expect(instance).to.be();
    });

    it('should have the property codePost (base name: "CodePost")', function() {
      // uncomment below and update the code to test the property codePost
      //var instance = new ProffixRestApiRequestSammlung.Land11();
      //expect(instance).to.be();
    });
