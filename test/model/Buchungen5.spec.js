...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Buchungen5();
  });
  ...
  describe('Buchungen5', function() {
    it('should create an instance of Buchungen5', function() {
      // uncomment below and update the code to test Buchungen5
      //var instance = new ProffixRestApiRequestSammlung.Buchungen5();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Buchungen5);
    });
