...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.AUFOccasionsobjektOccasionsobjektNr();
  });
  ...
  describe('AUFOccasionsobjektOccasionsobjektNr', function() {
    it('should create an instance of AUFOccasionsobjektOccasionsobjektNr', function() {
      // uncomment below and update the code to test AUFOccasionsobjektOccasionsobjektNr
      //var instance = new ProffixRestApiRequestSammlung.AUFOccasionsobjektOccasionsobjektNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.AUFOccasionsobjektOccasionsobjektNr);
    });

    it('should have the property occasionsobjektNr (base name: "OccasionsobjektNr")', function() {
      // uncomment below and update the code to test the property occasionsobjektNr
      //var instance = new ProffixRestApiRequestSammlung.AUFOccasionsobjektOccasionsobjektNr();
