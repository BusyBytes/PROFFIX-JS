...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.EinheitLager1();
  });
  ...
  describe('EinheitLager1', function() {
    it('should create an instance of EinheitLager1', function() {
      // uncomment below and update the code to test EinheitLager1
      //var instance = new ProffixRestApiRequestSammlung.EinheitLager1();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.EinheitLager1);
    });
