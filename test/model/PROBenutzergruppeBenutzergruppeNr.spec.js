...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROBenutzergruppeBenutzergruppeNr();
  });
  ...
  describe('PROBenutzergruppeBenutzergruppeNr', function() {
    it('should create an instance of PROBenutzergruppeBenutzergruppeNr', function() {
      // uncomment below and update the code to test PROBenutzergruppeBenutzergruppeNr
      //var instance = new ProffixRestApiRequestSammlung.PROBenutzergruppeBenutzergruppeNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROBenutzergruppeBenutzergruppeNr);
    });

    it('should have the property benutzergruppeNr (base name: "BenutzergruppeNr")', function() {
      // uncomment below and update the code to test the property benutzergruppeNr
      //var instance = new ProffixRestApiRequestSammlung.PROBenutzergruppeBenutzergruppeNr();
    ...
    it('should have the property aDGruppe (base name: "ADGruppe")', function() {
      // uncomment below and update the code to test the property aDGruppe
      //var instance = new ProffixRestApiRequestSammlung.PROBenutzergruppeBenutzergruppeNr();
      //expect(instance).to.be();
    });
