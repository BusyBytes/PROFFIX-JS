...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Auftrag4();
  });
  ...
  describe('Auftrag4', function() {
    it('should create an instance of Auftrag4', function() {
      // uncomment below and update the code to test Auftrag4
      //var instance = new ProffixRestApiRequestSammlung.Auftrag4();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Auftrag4);
    });
