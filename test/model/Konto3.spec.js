...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Konto3();
  });
  ...
  describe('Konto3', function() {
    it('should create an instance of Konto3', function() {
      // uncomment below and update the code to test Konto3
      //var instance = new ProffixRestApiRequestSammlung.Konto3();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Konto3);
    });
