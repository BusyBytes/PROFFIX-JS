...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.DEBBuchungzahlungerfassenMittelsGutschriftRequest();
  });
  ...
  describe('DEBBuchungzahlungerfassenMittelsGutschriftRequest', function() {
    it('should create an instance of DEBBuchungzahlungerfassenMittelsGutschriftRequest', function() {
      // uncomment below and update the code to test DEBBuchungzahlungerfassenMittelsGutschriftRequest
      //var instance = new ProffixRestApiRequestSammlung.DEBBuchungzahlungerfassenMittelsGutschriftRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.DEBBuchungzahlungerfassenMittelsGutschriftRequest);
    });
