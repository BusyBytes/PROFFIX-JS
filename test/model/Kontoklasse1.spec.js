...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Kontoklasse1();
  });
  ...
  describe('Kontoklasse1', function() {
    it('should create an instance of Kontoklasse1', function() {
      // uncomment below and update the code to test Kontoklasse1
      //var instance = new ProffixRestApiRequestSammlung.Kontoklasse1();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Kontoklasse1);
    });
