...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LOHKrankentaggeldversicherungscodeKrankentaggeldversicherungscodeNr();
  });
  ...
  describe('LOHKrankentaggeldversicherungscodeKrankentaggeldversicherungscodeNr', function() {
    it('should create an instance of LOHKrankentaggeldversicherungscodeKrankentaggeldversicherungscodeNr', function() {
      // uncomment below and update the code to test LOHKrankentaggeldversicherungscodeKrankentaggeldversicherungscodeNr
      //var instance = new ProffixRestApiRequestSammlung.LOHKrankentaggeldversicherungscodeKrankentaggeldversicherungscodeNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LOHKrankentaggeldversicherungscodeKrankentaggeldversicherungscodeNr);
    });

    it('should have the property krankentaggeldversicherungscodeNr (base name: "KrankentaggeldversicherungscodeNr")', function() {
      // uncomment below and update the code to test the property krankentaggeldversicherungscodeNr
      //var instance = new ProffixRestApiRequestSammlung.LOHKrankentaggeldversicherungscodeKrankentaggeldversicherungscodeNr();
