...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LAGArtikelgruppeArtikelgruppeNr();
  });
  ...
  describe('LAGArtikelgruppeArtikelgruppeNr', function() {
    it('should create an instance of LAGArtikelgruppeArtikelgruppeNr', function() {
      // uncomment below and update the code to test LAGArtikelgruppeArtikelgruppeNr
      //var instance = new ProffixRestApiRequestSammlung.LAGArtikelgruppeArtikelgruppeNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LAGArtikelgruppeArtikelgruppeNr);
    });

    it('should have the property artikelgruppeNr (base name: "ArtikelgruppeNr")', function() {
      // uncomment below and update the code to test the property artikelgruppeNr
      //var instance = new ProffixRestApiRequestSammlung.LAGArtikelgruppeArtikelgruppeNr();
