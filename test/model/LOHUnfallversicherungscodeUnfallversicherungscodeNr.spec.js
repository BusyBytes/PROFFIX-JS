...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.LOHUnfallversicherungscodeUnfallversicherungscodeNr();
  });
  ...
  describe('LOHUnfallversicherungscodeUnfallversicherungscodeNr', function() {
    it('should create an instance of LOHUnfallversicherungscodeUnfallversicherungscodeNr', function() {
      // uncomment below and update the code to test LOHUnfallversicherungscodeUnfallversicherungscodeNr
      //var instance = new ProffixRestApiRequestSammlung.LOHUnfallversicherungscodeUnfallversicherungscodeNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.LOHUnfallversicherungscodeUnfallversicherungscodeNr);
    });

    it('should have the property unfallversicherungscodeNr (base name: "UnfallversicherungscodeNr")', function() {
      // uncomment below and update the code to test the property unfallversicherungscodeNr
      //var instance = new ProffixRestApiRequestSammlung.LOHUnfallversicherungscodeUnfallversicherungscodeNr();
