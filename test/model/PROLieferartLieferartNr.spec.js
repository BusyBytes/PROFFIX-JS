...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROLieferartLieferartNr();
  });
  ...
  describe('PROLieferartLieferartNr', function() {
    it('should create an instance of PROLieferartLieferartNr', function() {
      // uncomment below and update the code to test PROLieferartLieferartNr
      //var instance = new ProffixRestApiRequestSammlung.PROLieferartLieferartNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROLieferartLieferartNr);
    });

    it('should have the property lieferartNr (base name: "LieferartNr")', function() {
      // uncomment below and update the code to test the property lieferartNr
      //var instance = new ProffixRestApiRequestSammlung.PROLieferartLieferartNr();
