...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Belegart();
  });
  ...
  describe('Belegart', function() {
    it('should create an instance of Belegart', function() {
      // uncomment below and update the code to test Belegart
      //var instance = new ProffixRestApiRequestSammlung.Belegart();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Belegart);
    });

    it('should have the property belegartNr (base name: "BelegartNr")', function() {
      // uncomment below and update the code to test the property belegartNr
      //var instance = new ProffixRestApiRequestSammlung.Belegart();
