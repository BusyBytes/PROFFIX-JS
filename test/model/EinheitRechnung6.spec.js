...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.EinheitRechnung6();
  });
  ...
  describe('EinheitRechnung6', function() {
    it('should create an instance of EinheitRechnung6', function() {
      // uncomment below and update the code to test EinheitRechnung6
      //var instance = new ProffixRestApiRequestSammlung.EinheitRechnung6();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.EinheitRechnung6);
    });

    it('should have the property einheitNr (base name: "EinheitNr")', function() {
      // uncomment below and update the code to test the property einheitNr
      //var instance = new ProffixRestApiRequestSammlung.EinheitRechnung6();
    ...
    it('should have the property abkuerzung (base name: "Abkuerzung")', function() {
      // uncomment below and update the code to test the property abkuerzung
      //var instance = new ProffixRestApiRequestSammlung.EinheitRechnung6();
      //expect(instance).to.be();
    });
