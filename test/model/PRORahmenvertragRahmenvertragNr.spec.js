...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PRORahmenvertragRahmenvertragNr();
  });
  ...
  describe('PRORahmenvertragRahmenvertragNr', function() {
    it('should create an instance of PRORahmenvertragRahmenvertragNr', function() {
      // uncomment below and update the code to test PRORahmenvertragRahmenvertragNr
      //var instance = new ProffixRestApiRequestSammlung.PRORahmenvertragRahmenvertragNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PRORahmenvertragRahmenvertragNr);
    });

    it('should have the property rahmenvertragNr (base name: "RahmenvertragNr")', function() {
      // uncomment below and update the code to test the property rahmenvertragNr
      //var instance = new ProffixRestApiRequestSammlung.PRORahmenvertragRahmenvertragNr();
