...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROEinheitEinheitNr();
  });
  ...
  describe('PROEinheitEinheitNr', function() {
    it('should create an instance of PROEinheitEinheitNr', function() {
      // uncomment below and update the code to test PROEinheitEinheitNr
      //var instance = new ProffixRestApiRequestSammlung.PROEinheitEinheitNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROEinheitEinheitNr);
    });
