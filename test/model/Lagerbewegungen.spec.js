...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Lagerbewegungen();
  });
  ...
  describe('Lagerbewegungen', function() {
    it('should create an instance of Lagerbewegungen', function() {
      // uncomment below and update the code to test Lagerbewegungen
      //var instance = new ProffixRestApiRequestSammlung.Lagerbewegungen();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Lagerbewegungen);
    });
