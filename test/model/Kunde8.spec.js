...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Kunde8();
  });
  ...
  describe('Kunde8', function() {
    it('should create an instance of Kunde8', function() {
      // uncomment below and update the code to test Kunde8
      //var instance = new ProffixRestApiRequestSammlung.Kunde8();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Kunde8);
    });
