...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Steuercode20();
  });
  ...
  describe('Steuercode20', function() {
    it('should create an instance of Steuercode20', function() {
      // uncomment below and update the code to test Steuercode20
      //var instance = new ProffixRestApiRequestSammlung.Steuercode20();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Steuercode20);
    });
