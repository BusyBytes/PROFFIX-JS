...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.PROBenutzereinstellungBenutzereinstellungNr();
  });
  ...
  describe('PROBenutzereinstellungBenutzereinstellungNr', function() {
    it('should create an instance of PROBenutzereinstellungBenutzereinstellungNr', function() {
      // uncomment below and update the code to test PROBenutzereinstellungBenutzereinstellungNr
      //var instance = new ProffixRestApiRequestSammlung.PROBenutzereinstellungBenutzereinstellungNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.PROBenutzereinstellungBenutzereinstellungNr);
    });
