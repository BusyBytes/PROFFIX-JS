...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.Positionen2();
  });
  ...
  describe('Positionen2', function() {
    it('should create an instance of Positionen2', function() {
      // uncomment below and update the code to test Positionen2
      //var instance = new ProffixRestApiRequestSammlung.Positionen2();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.Positionen2);
    });
