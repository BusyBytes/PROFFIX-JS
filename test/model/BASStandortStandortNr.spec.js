...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.BASStandortStandortNr();
  });
  ...
  describe('BASStandortStandortNr', function() {
    it('should create an instance of BASStandortStandortNr', function() {
      // uncomment below and update the code to test BASStandortStandortNr
      //var instance = new ProffixRestApiRequestSammlung.BASStandortStandortNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.BASStandortStandortNr);
    });
