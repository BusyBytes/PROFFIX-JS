...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.AUFDokumentDokumentNrumwandelnRequest();
  });
  ...
  describe('AUFDokumentDokumentNrumwandelnRequest', function() {
    it('should create an instance of AUFDokumentDokumentNrumwandelnRequest', function() {
      // uncomment below and update the code to test AUFDokumentDokumentNrumwandelnRequest
      //var instance = new ProffixRestApiRequestSammlung.AUFDokumentDokumentNrumwandelnRequest();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.AUFDokumentDokumentNrumwandelnRequest);
    });
