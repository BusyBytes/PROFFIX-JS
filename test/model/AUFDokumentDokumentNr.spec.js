...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProffixRestApiRequestSammlung.AUFDokumentDokumentNr();
  });
  ...
  describe('AUFDokumentDokumentNr', function() {
    it('should create an instance of AUFDokumentDokumentNr', function() {
      // uncomment below and update the code to test AUFDokumentDokumentNr
      //var instance = new ProffixRestApiRequestSammlung.AUFDokumentDokumentNr();
      //expect(instance).to.be.a(ProffixRestApiRequestSammlung.AUFDokumentDokumentNr);
    });
    ...
    it('should have the property portoErtragskonto (base name: "PortoErtragskonto")', function() {
      // uncomment below and update the code to test the property portoErtragskonto
      //var instance = new ProffixRestApiRequestSammlung.AUFDokumentDokumentNr();
      //expect(instance).to.be();
    });
