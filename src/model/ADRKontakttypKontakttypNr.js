...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.ADRKontakttypKontakttypNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The ADRKontakttypKontakttypNr model module.
   * @module model/ADRKontakttypKontakttypNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>ADRKontakttypKontakttypNr</code>.
   * @alias module:model/ADRKontakttypKontakttypNr
   * @class
   ...
   */
  var exports = function(kontakttypNr, bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;
  ...
  /**
   * Constructs a <code>ADRKontakttypKontakttypNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ADRKontakttypKontakttypNr} obj Optional instance to populate.
   * @return {module:model/ADRKontakttypKontakttypNr} The populated <code>ADRKontakttypKontakttypNr</code> instance.
   */
