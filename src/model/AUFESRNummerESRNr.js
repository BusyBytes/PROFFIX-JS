...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.AUFESRNummerESRNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The AUFESRNummerESRNr model module.
   * @module model/AUFESRNummerESRNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>AUFESRNummerESRNr</code>.
   * @alias module:model/AUFESRNummerESRNr
   * @class
   * @param eSRNr {Number} 
   ...
   */
  var exports = function(eSRNr, bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;
  ...
  /**
   * Constructs a <code>AUFESRNummerESRNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AUFESRNummerESRNr} obj Optional instance to populate.
   * @return {module:model/AUFESRNummerESRNr} The populated <code>AUFESRNummerESRNr</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('ESRNr')) {
        obj['ESRNr'] = ApiClient.convertToType(data['ESRNr'], 'Number');
      }
   ...
   * @member {Number} ESRNr
   */
  exports.prototype['ESRNr'] = undefined;
  /**
