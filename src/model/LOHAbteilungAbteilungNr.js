...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.LOHAbteilungAbteilungNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The LOHAbteilungAbteilungNr model module.
   * @module model/LOHAbteilungAbteilungNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>LOHAbteilungAbteilungNr</code>.
   * @alias module:model/LOHAbteilungAbteilungNr
   * @class
   * @param abteilungNr {Number} 
   ...
   */
  var exports = function(abteilungNr, bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;

    _this['AbteilungNr'] = abteilungNr;
  ...
  /**
   * Constructs a <code>LOHAbteilungAbteilungNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LOHAbteilungAbteilungNr} obj Optional instance to populate.
   * @return {module:model/LOHAbteilungAbteilungNr} The populated <code>LOHAbteilungAbteilungNr</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('AbteilungNr')) {
        obj['AbteilungNr'] = ApiClient.convertToType(data['AbteilungNr'], 'Number');
      }
  ...
  /**
   * @member {Number} AbteilungNr
   */
  exports.prototype['AbteilungNr'] = undefined;
  /**
