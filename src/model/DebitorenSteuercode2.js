...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.DebitorenSteuercode2 = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The DebitorenSteuercode2 model module.
   * @module model/DebitorenSteuercode2
   * @version 1.0
   */

  /**
   * Constructs a new <code>DebitorenSteuercode2</code>.
   * @alias module:model/DebitorenSteuercode2
   * @class
   ...
   */
  var exports = function(steuercodeNr, bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;
  ...
  /**
   * Constructs a <code>DebitorenSteuercode2</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DebitorenSteuercode2} obj Optional instance to populate.
   * @return {module:model/DebitorenSteuercode2} The populated <code>DebitorenSteuercode2</code> instance.
   */
