...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.LAGSammelartikelSammelartikelNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The LAGSammelartikelSammelartikelNr model module.
   * @module model/LAGSammelartikelSammelartikelNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>LAGSammelartikelSammelartikelNr</code>.
   * @alias module:model/LAGSammelartikelSammelartikelNr
   * @class
   * @param sammelartikelNr {String} 
   ...
   */
  var exports = function(sammelartikelNr, bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;

    _this['SammelartikelNr'] = sammelartikelNr;
  ...
  /**
   * Constructs a <code>LAGSammelartikelSammelartikelNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LAGSammelartikelSammelartikelNr} obj Optional instance to populate.
   * @return {module:model/LAGSammelartikelSammelartikelNr} The populated <code>LAGSammelartikelSammelartikelNr</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('SammelartikelNr')) {
        obj['SammelartikelNr'] = ApiClient.convertToType(data['SammelartikelNr'], 'String');
      }
  ...
  /**
   * @member {String} SammelartikelNr
   */
  exports.prototype['SammelartikelNr'] = undefined;
  /**
