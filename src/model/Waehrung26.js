...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.Waehrung26 = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The Waehrung26 model module.
   * @module model/Waehrung26
   * @version 1.0
   */

  /**
   * Constructs a new <code>Waehrung26</code>.
   * @alias module:model/Waehrung26
   * @class
  ...
  /**
   * Constructs a <code>Waehrung26</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Waehrung26} obj Optional instance to populate.
   * @return {module:model/Waehrung26} The populated <code>Waehrung26</code> instance.
   */
