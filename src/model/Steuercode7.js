...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.Steuercode7 = factory(root.ProffixRestApiRequestSammlung.ApiClient, root.ProffixRestApiRequestSammlung.Konto3);
  }
  ...
  /**
   * The Steuercode7 model module.
   * @module model/Steuercode7
   * @version 1.0
   */

  /**
   * Constructs a new <code>Steuercode7</code>.
   * @alias module:model/Steuercode7
   * @class
  ...
  /**
   * Constructs a <code>Steuercode7</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Steuercode7} obj Optional instance to populate.
   * @return {module:model/Steuercode7} The populated <code>Steuercode7</code> instance.
   */
