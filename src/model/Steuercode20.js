...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.Steuercode20 = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The Steuercode20 model module.
   * @module model/Steuercode20
   * @version 1.0
   */

  /**
   * Constructs a new <code>Steuercode20</code>.
   * @alias module:model/Steuercode20
   * @class
  ...
  /**
   * Constructs a <code>Steuercode20</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Steuercode20} obj Optional instance to populate.
   * @return {module:model/Steuercode20} The populated <code>Steuercode20</code> instance.
   */
