...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.EinheitRechnung1 = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The EinheitRechnung1 model module.
   * @module model/EinheitRechnung1
   * @version 1.0
   */

  /**
   * Constructs a new <code>EinheitRechnung1</code>.
   * @alias module:model/EinheitRechnung1
   * @class
  ...
  /**
   * Constructs a <code>EinheitRechnung1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EinheitRechnung1} obj Optional instance to populate.
   * @return {module:model/EinheitRechnung1} The populated <code>EinheitRechnung1</code> instance.
   */
