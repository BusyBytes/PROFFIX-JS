...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/EinheitLager', 'model/EinheitRechnung'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./EinheitLager'), require('./EinheitRechnung'));
  } else {
    // Browser globals (root is window)
    if (!root.ProffixRestApiRequestSammlung) {
      root.ProffixRestApiRequestSammlung = {};
    }
    root.ProffixRestApiRequestSammlung.PROEinheitsmatrixEinheitLager = factory(root.ProffixRestApiRequestSammlung.ApiClient, root.ProffixRestApiRequestSammlung.EinheitLager, root.ProffixRestApiRequestSammlung.EinheitRechnung);
  }
}(this, function(ApiClient, EinheitLager, EinheitRechnung) {
  'use strict';
  ...
  /**
   * The PROEinheitsmatrixEinheitLager model module.
   * @module model/PROEinheitsmatrixEinheitLager
   * @version 1.0
   */

  /**
   * Constructs a new <code>PROEinheitsmatrixEinheitLager</code>.
   * @alias module:model/PROEinheitsmatrixEinheitLager
   * @class
  ...
  /**
   * Constructs a <code>PROEinheitsmatrixEinheitLager</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PROEinheitsmatrixEinheitLager} obj Optional instance to populate.
   * @return {module:model/PROEinheitsmatrixEinheitLager} The populated <code>PROEinheitsmatrixEinheitLager</code> instance.
   */
