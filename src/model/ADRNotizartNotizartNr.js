...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.ADRNotizartNotizartNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The ADRNotizartNotizartNr model module.
   * @module model/ADRNotizartNotizartNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>ADRNotizartNotizartNr</code>.
   * @alias module:model/ADRNotizartNotizartNr
   * @class
   ...
   */
  var exports = function(notizartNr, bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;
  ...
  /**
   * Constructs a <code>ADRNotizartNotizartNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ADRNotizartNotizartNr} obj Optional instance to populate.
   * @return {module:model/ADRNotizartNotizartNr} The populated <code>ADRNotizartNotizartNr</code> instance.
   */
