...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.PROSpracheSpracheNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The PROSpracheSpracheNr model module.
   * @module model/PROSpracheSpracheNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>PROSpracheSpracheNr</code>.
   * @alias module:model/PROSpracheSpracheNr
   * @class
   ...
   */
  var exports = function(spracheNr, bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;
  ...
  /**
   * Constructs a <code>PROSpracheSpracheNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PROSpracheSpracheNr} obj Optional instance to populate.
   * @return {module:model/PROSpracheSpracheNr} The populated <code>PROSpracheSpracheNr</code> instance.
   */
