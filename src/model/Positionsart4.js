...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.Positionsart4 = factory(root.ProffixRestApiRequestSammlung.ApiClient, root.ProffixRestApiRequestSammlung.Ertragskonto, root.ProffixRestApiRequestSammlung.Steuercode1, root.ProffixRestApiRequestSammlung.Waehrung);
  }
  ...
  /**
   * The Positionsart4 model module.
   * @module model/Positionsart4
   * @version 1.0
   */

  /**
   * Constructs a new <code>Positionsart4</code>.
   * @alias module:model/Positionsart4
   * @class
  ...
  /**
   * Constructs a <code>Positionsart4</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Positionsart4} obj Optional instance to populate.
   * @return {module:model/Positionsart4} The populated <code>Positionsart4</code> instance.
   */
