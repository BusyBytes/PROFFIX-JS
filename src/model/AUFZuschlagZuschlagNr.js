...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.AUFZuschlagZuschlagNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The AUFZuschlagZuschlagNr model module.
   * @module model/AUFZuschlagZuschlagNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>AUFZuschlagZuschlagNr</code>.
   * @alias module:model/AUFZuschlagZuschlagNr
   * @class
   * @param zuschlagNr {String} 
   ...
   */
  var exports = function(zuschlagNr, bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;

    _this['ZuschlagNr'] = zuschlagNr;
  ...
  /**
   * Constructs a <code>AUFZuschlagZuschlagNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AUFZuschlagZuschlagNr} obj Optional instance to populate.
   * @return {module:model/AUFZuschlagZuschlagNr} The populated <code>AUFZuschlagZuschlagNr</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('ZuschlagNr')) {
        obj['ZuschlagNr'] = ApiClient.convertToType(data['ZuschlagNr'], 'String');
      }
  ...
  /**
   * @member {String} ZuschlagNr
   */
  exports.prototype['ZuschlagNr'] = undefined;
  /**
