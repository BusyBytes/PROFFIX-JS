...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.LAGArtikeluntergruppeArtikeluntergruppeNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The LAGArtikeluntergruppeArtikeluntergruppeNr model module.
   * @module model/LAGArtikeluntergruppeArtikeluntergruppeNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>LAGArtikeluntergruppeArtikeluntergruppeNr</code>.
   * @alias module:model/LAGArtikeluntergruppeArtikeluntergruppeNr
   * @class
   * @param artikeluntergruppeNr {String} 
   ...
   */
  var exports = function(artikeluntergruppeNr, bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;

    _this['ArtikeluntergruppeNr'] = artikeluntergruppeNr;
  ...
  /**
   * Constructs a <code>LAGArtikeluntergruppeArtikeluntergruppeNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LAGArtikeluntergruppeArtikeluntergruppeNr} obj Optional instance to populate.
   * @return {module:model/LAGArtikeluntergruppeArtikeluntergruppeNr} The populated <code>LAGArtikeluntergruppeArtikeluntergruppeNr</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('ArtikeluntergruppeNr')) {
        obj['ArtikeluntergruppeNr'] = ApiClient.convertToType(data['ArtikeluntergruppeNr'], 'String');
      }
  ...
  /**
   * @member {String} ArtikeluntergruppeNr
   */
  exports.prototype['ArtikeluntergruppeNr'] = undefined;
  /**
