...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.LAGArtikelgruppeArtikelgruppeNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The LAGArtikelgruppeArtikelgruppeNr model module.
   * @module model/LAGArtikelgruppeArtikelgruppeNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>LAGArtikelgruppeArtikelgruppeNr</code>.
   * @alias module:model/LAGArtikelgruppeArtikelgruppeNr
   * @class
   ...
   */
  var exports = function(artikelgruppeNr, bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;
  ...
  /**
   * Constructs a <code>LAGArtikelgruppeArtikelgruppeNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LAGArtikelgruppeArtikelgruppeNr} obj Optional instance to populate.
   * @return {module:model/LAGArtikelgruppeArtikelgruppeNr} The populated <code>LAGArtikelgruppeArtikelgruppeNr</code> instance.
   */
