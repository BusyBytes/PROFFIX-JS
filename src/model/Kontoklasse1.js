...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.Kontoklasse1 = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The Kontoklasse1 model module.
   * @module model/Kontoklasse1
   * @version 1.0
   */

  /**
   * Constructs a new <code>Kontoklasse1</code>.
   * @alias module:model/Kontoklasse1
   * @class
  ...
  /**
   * Constructs a <code>Kontoklasse1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Kontoklasse1} obj Optional instance to populate.
   * @return {module:model/Kontoklasse1} The populated <code>Kontoklasse1</code> instance.
   */
