...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.PROFunktionFunktionNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The PROFunktionFunktionNr model module.
   * @module model/PROFunktionFunktionNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>PROFunktionFunktionNr</code>.
   * @alias module:model/PROFunktionFunktionNr
   * @class
   * @param funktionNr {Number} 
   ...
   */
  var exports = function(funktionNr, bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;

    _this['FunktionNr'] = funktionNr;
  ...
  /**
   * Constructs a <code>PROFunktionFunktionNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PROFunktionFunktionNr} obj Optional instance to populate.
   * @return {module:model/PROFunktionFunktionNr} The populated <code>PROFunktionFunktionNr</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('FunktionNr')) {
        obj['FunktionNr'] = ApiClient.convertToType(data['FunktionNr'], 'Number');
      }
  ...
  /**
   * @member {Number} FunktionNr
   */
  exports.prototype['FunktionNr'] = undefined;
  /**
