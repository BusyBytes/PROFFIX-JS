...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.STUTeilleistungstypTeilleistungstypNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The STUTeilleistungstypTeilleistungstypNr model module.
   * @module model/STUTeilleistungstypTeilleistungstypNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>STUTeilleistungstypTeilleistungstypNr</code>.
   * @alias module:model/STUTeilleistungstypTeilleistungstypNr
   * @class
   ...
   */
  var exports = function(teilleistungstypNr, bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;
  ...
  /**
   * Constructs a <code>STUTeilleistungstypTeilleistungstypNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/STUTeilleistungstypTeilleistungstypNr} obj Optional instance to populate.
   * @return {module:model/STUTeilleistungstypTeilleistungstypNr} The populated <code>STUTeilleistungstypTeilleistungstypNr</code> instance.
   */
