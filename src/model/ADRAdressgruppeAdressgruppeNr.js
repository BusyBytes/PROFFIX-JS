...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.ADRAdressgruppeAdressgruppeNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The ADRAdressgruppeAdressgruppeNr model module.
   * @module model/ADRAdressgruppeAdressgruppeNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>ADRAdressgruppeAdressgruppeNr</code>.
   * @alias module:model/ADRAdressgruppeAdressgruppeNr
   * @class
  ...
  /**
   * Constructs a <code>ADRAdressgruppeAdressgruppeNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ADRAdressgruppeAdressgruppeNr} obj Optional instance to populate.
   * @return {module:model/ADRAdressgruppeAdressgruppeNr} The populated <code>ADRAdressgruppeAdressgruppeNr</code> instance.
   */
