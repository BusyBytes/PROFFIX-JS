...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.LOHLohnartLohnartNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The LOHLohnartLohnartNr model module.
   * @module model/LOHLohnartLohnartNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>LOHLohnartLohnartNr</code>.
   * @alias module:model/LOHLohnartLohnartNr
   * @class
   ...
   */
  var exports = function(lohnartNr, bezeichnung, geloescht, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;
  ...
  /**
   * Constructs a <code>LOHLohnartLohnartNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LOHLohnartLohnartNr} obj Optional instance to populate.
   * @return {module:model/LOHLohnartLohnartNr} The populated <code>LOHLohnartLohnartNr</code> instance.
   */
