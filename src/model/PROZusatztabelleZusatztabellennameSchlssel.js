...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.PROZusatztabelleZusatztabellennameSchlssel = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The PROZusatztabelleZusatztabellennameSchlssel model module.
   * @module model/PROZusatztabelleZusatztabellennameSchlssel
   * @version 1.0
   */

  /**
   * Constructs a new <code>PROZusatztabelleZusatztabellennameSchlssel</code>.
   * @alias module:model/PROZusatztabelleZusatztabellennameSchlssel
   * @class
   * @param dVDNr {Number} 
  ...
  /**
   * Constructs a <code>PROZusatztabelleZusatztabellennameSchlssel</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PROZusatztabelleZusatztabellennameSchlssel} obj Optional instance to populate.
   * @return {module:model/PROZusatztabelleZusatztabellennameSchlssel} The populated <code>PROZusatztabelleZusatztabellennameSchlssel</code> instance.
   */
