...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.SRVServiceartServiceartNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The SRVServiceartServiceartNr model module.
   * @module model/SRVServiceartServiceartNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>SRVServiceartServiceartNr</code>.
   * @alias module:model/SRVServiceartServiceartNr
   * @class
   * @param serviceartNr {String} 
   ...
   */
  var exports = function(serviceartNr, bezeichnung, beschrieb, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;

    _this['ServiceartNr'] = serviceartNr;
  ...
  /**
   * Constructs a <code>SRVServiceartServiceartNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SRVServiceartServiceartNr} obj Optional instance to populate.
   * @return {module:model/SRVServiceartServiceartNr} The populated <code>SRVServiceartServiceartNr</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('ServiceartNr')) {
        obj['ServiceartNr'] = ApiClient.convertToType(data['ServiceartNr'], 'String');
      }
  ...
  /**
   * @member {String} ServiceartNr
   */
  exports.prototype['ServiceartNr'] = undefined;
  /**
