...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.Aufgabe = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The Aufgabe model module.
   * @module model/Aufgabe
   * @version 1.0
   */

  /**
   * Constructs a new <code>Aufgabe</code>.
   * @alias module:model/Aufgabe
   * @class
  ...
  /**
   * Constructs a <code>Aufgabe</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Aufgabe} obj Optional instance to populate.
   * @return {module:model/Aufgabe} The populated <code>Aufgabe</code> instance.
   */
