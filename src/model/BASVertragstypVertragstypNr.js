...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.BASVertragstypVertragstypNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The BASVertragstypVertragstypNr model module.
   * @module model/BASVertragstypVertragstypNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>BASVertragstypVertragstypNr</code>.
   * @alias module:model/BASVertragstypVertragstypNr
   * @class
   * @param vertragstypNr {String} 
   * @param bezeichnung {String} 
   * @param beschrieb {String} 
   ...
   */
  var exports = function(vertragstypNr, bezeichnung, beschrieb, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;

    _this['VertragstypNr'] = vertragstypNr;
    _this['Bezeichnung'] = bezeichnung;
    _this['Beschrieb'] = beschrieb;
  ...
  /**
   * Constructs a <code>BASVertragstypVertragstypNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BASVertragstypVertragstypNr} obj Optional instance to populate.
   * @return {module:model/BASVertragstypVertragstypNr} The populated <code>BASVertragstypVertragstypNr</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('VertragstypNr')) {
        obj['VertragstypNr'] = ApiClient.convertToType(data['VertragstypNr'], 'String');
      }
      if (data.hasOwnProperty('Bezeichnung')) {
        obj['Bezeichnung'] = ApiClient.convertToType(data['Bezeichnung'], 'String');
      }
      if (data.hasOwnProperty('Beschrieb')) {
        obj['Beschrieb'] = ApiClient.convertToType(data['Beschrieb'], 'String');
      }
  ...
  /**
   * @member {String} VertragstypNr
   */
  exports.prototype['VertragstypNr'] = undefined;
  /**
   * @member {String} Bezeichnung
   */
  exports.prototype['Bezeichnung'] = undefined;
  /**
   * @member {String} Beschrieb
   */
  exports.prototype['Beschrieb'] = undefined;
  /**
