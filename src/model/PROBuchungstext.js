...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.PROBuchungstext = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The PROBuchungstext model module.
   * @module model/PROBuchungstext
   * @version 1.0
   */

  /**
   * Constructs a new <code>PROBuchungstext</code>.
   * @alias module:model/PROBuchungstext
   * @class
   ...
   */
  var exports = function(bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;
  ...
  /**
   * Constructs a <code>PROBuchungstext</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PROBuchungstext} obj Optional instance to populate.
   * @return {module:model/PROBuchungstext} The populated <code>PROBuchungstext</code> instance.
   */
