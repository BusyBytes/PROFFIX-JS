...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.PROEinheitEinheitNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The PROEinheitEinheitNr model module.
   * @module model/PROEinheitEinheitNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>PROEinheitEinheitNr</code>.
   * @alias module:model/PROEinheitEinheitNr
   * @class
  ...
  /**
   * Constructs a <code>PROEinheitEinheitNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PROEinheitEinheitNr} obj Optional instance to populate.
   * @return {module:model/PROEinheitEinheitNr} The populated <code>PROEinheitEinheitNr</code> instance.
   */
