...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.AUFDokumentDokumentNrentsperrenRequest = factory(root.ProffixRestApiRequestSammlung.ApiClient, root.ProffixRestApiRequestSammlung.Adresse, root.ProffixRestApiRequestSammlung.Dokumenttyp, root.ProffixRestApiRequestSammlung.Positionen2);
  }
  ...
  /**
   * The AUFDokumentDokumentNrentsperrenRequest model module.
   * @module model/AUFDokumentDokumentNrentsperrenRequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>AUFDokumentDokumentNrentsperrenRequest</code>.
   * @alias module:model/AUFDokumentDokumentNrentsperrenRequest
   * @class
  ...
  /**
   * Constructs a <code>AUFDokumentDokumentNrentsperrenRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AUFDokumentDokumentNrentsperrenRequest} obj Optional instance to populate.
   * @return {module:model/AUFDokumentDokumentNrentsperrenRequest} The populated <code>AUFDokumentDokumentNrentsperrenRequest</code> instance.
   */
