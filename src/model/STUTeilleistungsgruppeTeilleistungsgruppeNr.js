...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.STUTeilleistungsgruppeTeilleistungsgruppeNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The STUTeilleistungsgruppeTeilleistungsgruppeNr model module.
   * @module model/STUTeilleistungsgruppeTeilleistungsgruppeNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>STUTeilleistungsgruppeTeilleistungsgruppeNr</code>.
   * @alias module:model/STUTeilleistungsgruppeTeilleistungsgruppeNr
   * @class
   * @param teilleistungsgruppeNr {Number} 
   ...
   */
  var exports = function(teilleistungsgruppeNr, bezeichnung, gliederung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;

    _this['TeilleistungsgruppeNr'] = teilleistungsgruppeNr;
  ...
  /**
   * Constructs a <code>STUTeilleistungsgruppeTeilleistungsgruppeNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/STUTeilleistungsgruppeTeilleistungsgruppeNr} obj Optional instance to populate.
   * @return {module:model/STUTeilleistungsgruppeTeilleistungsgruppeNr} The populated <code>STUTeilleistungsgruppeTeilleistungsgruppeNr</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('TeilleistungsgruppeNr')) {
        obj['TeilleistungsgruppeNr'] = ApiClient.convertToType(data['TeilleistungsgruppeNr'], 'Number');
      }
  ...
  /**
   * @member {Number} TeilleistungsgruppeNr
   */
  exports.prototype['TeilleistungsgruppeNr'] = undefined;
  /**
