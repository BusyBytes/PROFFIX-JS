...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.EinheitLager1 = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The EinheitLager1 model module.
   * @module model/EinheitLager1
   * @version 1.0
   */

  /**
   * Constructs a new <code>EinheitLager1</code>.
   * @alias module:model/EinheitLager1
   * @class
  ...
  /**
   * Constructs a <code>EinheitLager1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EinheitLager1} obj Optional instance to populate.
   * @return {module:model/EinheitLager1} The populated <code>EinheitLager1</code> instance.
   */
