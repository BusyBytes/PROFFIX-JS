...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.Land11 = factory(root.ProffixRestApiRequestSammlung.ApiClient, root.ProffixRestApiRequestSammlung.Waehrung);
  }
  ...
  /**
   * The Land11 model module.
   * @module model/Land11
   * @version 1.0
   */

  /**
   * Constructs a new <code>Land11</code>.
   * @alias module:model/Land11
   * @class
   * @param landNr {String} 
  ...
  /**
   * Constructs a <code>Land11</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Land11} obj Optional instance to populate.
   * @return {module:model/Land11} The populated <code>Land11</code> instance.
   */
