...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.LOHUnfallversicherungscodeUnfallversicherungscodeNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The LOHUnfallversicherungscodeUnfallversicherungscodeNr model module.
   * @module model/LOHUnfallversicherungscodeUnfallversicherungscodeNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>LOHUnfallversicherungscodeUnfallversicherungscodeNr</code>.
   * @alias module:model/LOHUnfallversicherungscodeUnfallversicherungscodeNr
   * @class
   ...
   */
  var exports = function(unfallversicherungscodeNr, bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;
  ...
  /**
   * Constructs a <code>LOHUnfallversicherungscodeUnfallversicherungscodeNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LOHUnfallversicherungscodeUnfallversicherungscodeNr} obj Optional instance to populate.
   * @return {module:model/LOHUnfallversicherungscodeUnfallversicherungscodeNr} The populated <code>LOHUnfallversicherungscodeUnfallversicherungscodeNr</code> instance.
   */
