...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.Auftrag6 = factory(root.ProffixRestApiRequestSammlung.ApiClient, root.ProffixRestApiRequestSammlung.Ertragskonto7, root.ProffixRestApiRequestSammlung.Kunde7, root.ProffixRestApiRequestSammlung.Positionsart4);
  }
  ...
  /**
   * The Auftrag6 model module.
   * @module model/Auftrag6
   * @version 1.0
   */

  /**
   * Constructs a new <code>Auftrag6</code>.
   * @alias module:model/Auftrag6
   * @class
  ...
  /**
   * Constructs a <code>Auftrag6</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Auftrag6} obj Optional instance to populate.
   * @return {module:model/Auftrag6} The populated <code>Auftrag6</code> instance.
   */
