...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.DebitorenWaehrung2 = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The DebitorenWaehrung2 model module.
   * @module model/DebitorenWaehrung2
   * @version 1.0
   */

  /**
   * Constructs a new <code>DebitorenWaehrung2</code>.
   * @alias module:model/DebitorenWaehrung2
   * @class
  ...
  /**
   * Constructs a <code>DebitorenWaehrung2</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DebitorenWaehrung2} obj Optional instance to populate.
   * @return {module:model/DebitorenWaehrung2} The populated <code>DebitorenWaehrung2</code> instance.
   */
