...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.PROWaehrungStandard = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The PROWaehrungStandard model module.
   * @module model/PROWaehrungStandard
   * @version 1.0
   */

  /**
   * Constructs a new <code>PROWaehrungStandard</code>.
   * @alias module:model/PROWaehrungStandard
   * @class
  ...
  /**
   * Constructs a <code>PROWaehrungStandard</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PROWaehrungStandard} obj Optional instance to populate.
   * @return {module:model/PROWaehrungStandard} The populated <code>PROWaehrungStandard</code> instance.
   */
