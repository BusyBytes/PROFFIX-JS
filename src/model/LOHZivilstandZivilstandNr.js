...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.LOHZivilstandZivilstandNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The LOHZivilstandZivilstandNr model module.
   * @module model/LOHZivilstandZivilstandNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>LOHZivilstandZivilstandNr</code>.
   * @alias module:model/LOHZivilstandZivilstandNr
   * @class
   ...
   */
  var exports = function(zivilstandNr, bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;
  ...
  /**
   * Constructs a <code>LOHZivilstandZivilstandNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LOHZivilstandZivilstandNr} obj Optional instance to populate.
   * @return {module:model/LOHZivilstandZivilstandNr} The populated <code>LOHZivilstandZivilstandNr</code> instance.
   */
