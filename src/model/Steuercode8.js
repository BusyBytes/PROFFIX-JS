...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.Steuercode8 = factory(root.ProffixRestApiRequestSammlung.ApiClient, root.ProffixRestApiRequestSammlung.Konto);
  }
  ...
  /**
   * The Steuercode8 model module.
   * @module model/Steuercode8
   * @version 1.0
   */

  /**
   * Constructs a new <code>Steuercode8</code>.
   * @alias module:model/Steuercode8
   * @class
  ...
  /**
   * Constructs a <code>Steuercode8</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Steuercode8} obj Optional instance to populate.
   * @return {module:model/Steuercode8} The populated <code>Steuercode8</code> instance.
   */
