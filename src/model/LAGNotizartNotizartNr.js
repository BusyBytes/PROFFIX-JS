...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.LAGNotizartNotizartNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The LAGNotizartNotizartNr model module.
   * @module model/LAGNotizartNotizartNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>LAGNotizartNotizartNr</code>.
   * @alias module:model/LAGNotizartNotizartNr
   * @class
  ...
  /**
   * Constructs a <code>LAGNotizartNotizartNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LAGNotizartNotizartNr} obj Optional instance to populate.
   * @return {module:model/LAGNotizartNotizartNr} The populated <code>LAGNotizartNotizartNr</code> instance.
   */
