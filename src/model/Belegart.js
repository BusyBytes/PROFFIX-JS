...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.Belegart = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The Belegart model module.
   * @module model/Belegart
   * @version 1.0
   */

  /**
   * Constructs a new <code>Belegart</code>.
   * @alias module:model/Belegart
   * @class
  ...
  /**
   * Constructs a <code>Belegart</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Belegart} obj Optional instance to populate.
   * @return {module:model/Belegart} The populated <code>Belegart</code> instance.
   */
