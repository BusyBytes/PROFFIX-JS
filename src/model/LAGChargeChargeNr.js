...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.LAGChargeChargeNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The LAGChargeChargeNr model module.
   * @module model/LAGChargeChargeNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>LAGChargeChargeNr</code>.
   * @alias module:model/LAGChargeChargeNr
   * @class
   ...
   */
  var exports = function(chargeNr, bezeichnung, inaktiv, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;
  ...
  /**
   * Constructs a <code>LAGChargeChargeNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/LAGChargeChargeNr} obj Optional instance to populate.
   * @return {module:model/LAGChargeChargeNr} The populated <code>LAGChargeChargeNr</code> instance.
   */
