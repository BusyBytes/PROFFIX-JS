...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.Ertragskonto7 = factory(root.ProffixRestApiRequestSammlung.ApiClient, root.ProffixRestApiRequestSammlung.Kontoklasse, root.ProffixRestApiRequestSammlung.Steuercode1);
  }
  ...
  /**
   * The Ertragskonto7 model module.
   * @module model/Ertragskonto7
   * @version 1.0
   */

  /**
   * Constructs a new <code>Ertragskonto7</code>.
   * @alias module:model/Ertragskonto7
   * @class
  ...
  /**
   * Constructs a <code>Ertragskonto7</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Ertragskonto7} obj Optional instance to populate.
   * @return {module:model/Ertragskonto7} The populated <code>Ertragskonto7</code> instance.
   */
