...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.BASAnlageAnlageNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The BASAnlageAnlageNr model module.
   * @module model/BASAnlageAnlageNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>BASAnlageAnlageNr</code>.
   * @alias module:model/BASAnlageAnlageNr
   * @class
   * @param anlageNr {String} 
   ...
   */
  var exports = function(anlageNr, bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;

    _this['AnlageNr'] = anlageNr;
  ...
  /**
   * Constructs a <code>BASAnlageAnlageNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/BASAnlageAnlageNr} obj Optional instance to populate.
   * @return {module:model/BASAnlageAnlageNr} The populated <code>BASAnlageAnlageNr</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('AnlageNr')) {
        obj['AnlageNr'] = ApiClient.convertToType(data['AnlageNr'], 'String');
      }
  ...
  /**
   * @member {String} AnlageNr
   */
  exports.prototype['AnlageNr'] = undefined;
  /**
