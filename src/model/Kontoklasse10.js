...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.Kontoklasse10 = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The Kontoklasse10 model module.
   * @module model/Kontoklasse10
   * @version 1.0
   */

  /**
   * Constructs a new <code>Kontoklasse10</code>.
   * @alias module:model/Kontoklasse10
   * @class
  ...
  /**
   * Constructs a <code>Kontoklasse10</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Kontoklasse10} obj Optional instance to populate.
   * @return {module:model/Kontoklasse10} The populated <code>Kontoklasse10</code> instance.
   */
