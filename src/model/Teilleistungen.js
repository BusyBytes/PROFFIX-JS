...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.Teilleistungen = factory(root.ProffixRestApiRequestSammlung.ApiClient, root.ProffixRestApiRequestSammlung.Teilleistungsgruppe, root.ProffixRestApiRequestSammlung.Teilleistungstyp);
  }
  ...
  /**
   * The Teilleistungen model module.
   * @module model/Teilleistungen
   * @version 1.0
   */

  /**
   * Constructs a new <code>Teilleistungen</code>.
   * @alias module:model/Teilleistungen
   * @class
  ...
  /**
   * Constructs a <code>Teilleistungen</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Teilleistungen} obj Optional instance to populate.
   * @return {module:model/Teilleistungen} The populated <code>Teilleistungen</code> instance.
   */
