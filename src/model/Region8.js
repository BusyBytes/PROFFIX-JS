...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.Region8 = factory(root.ProffixRestApiRequestSammlung.ApiClient, root.ProffixRestApiRequestSammlung.Land);
  }
  ...
  /**
   * The Region8 model module.
   * @module model/Region8
   * @version 1.0
   */

  /**
   * Constructs a new <code>Region8</code>.
   * @alias module:model/Region8
   * @class
  ...
  /**
   * Constructs a <code>Region8</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Region8} obj Optional instance to populate.
   * @return {module:model/Region8} The populated <code>Region8</code> instance.
   */
