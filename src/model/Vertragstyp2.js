...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.Vertragstyp2 = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The Vertragstyp2 model module.
   * @module model/Vertragstyp2
   * @version 1.0
   */

  /**
   * Constructs a new <code>Vertragstyp2</code>.
   * @alias module:model/Vertragstyp2
   * @class
  ...
  /**
   * Constructs a <code>Vertragstyp2</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Vertragstyp2} obj Optional instance to populate.
   * @return {module:model/Vertragstyp2} The populated <code>Vertragstyp2</code> instance.
   */
