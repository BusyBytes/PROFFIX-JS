...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.Aufgabe1 = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The Aufgabe1 model module.
   * @module model/Aufgabe1
   * @version 1.0
   */

  /**
   * Constructs a new <code>Aufgabe1</code>.
   * @alias module:model/Aufgabe1
   * @class
  ...
  /**
   * Constructs a <code>Aufgabe1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Aufgabe1} obj Optional instance to populate.
   * @return {module:model/Aufgabe1} The populated <code>Aufgabe1</code> instance.
   */
