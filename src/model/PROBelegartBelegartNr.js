...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.PROBelegartBelegartNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The PROBelegartBelegartNr model module.
   * @module model/PROBelegartBelegartNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>PROBelegartBelegartNr</code>.
   * @alias module:model/PROBelegartBelegartNr
   * @class
   * @param belegartNr {String} 
   ...
   */
  var exports = function(belegartNr, bezeichnung, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;

    _this['BelegartNr'] = belegartNr;
  ...
  /**
   * Constructs a <code>PROBelegartBelegartNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PROBelegartBelegartNr} obj Optional instance to populate.
   * @return {module:model/PROBelegartBelegartNr} The populated <code>PROBelegartBelegartNr</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();

      if (data.hasOwnProperty('BelegartNr')) {
        obj['BelegartNr'] = ApiClient.convertToType(data['BelegartNr'], 'String');
      }
  ...
  /**
   * @member {String} BelegartNr
   */
  exports.prototype['BelegartNr'] = undefined;
  /**
