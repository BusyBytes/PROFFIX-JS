...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.AUFDokumentstatusDokumentstatusNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The AUFDokumentstatusDokumentstatusNr model module.
   * @module model/AUFDokumentstatusDokumentstatusNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>AUFDokumentstatusDokumentstatusNr</code>.
   * @alias module:model/AUFDokumentstatusDokumentstatusNr
   * @class
   ...
   */
  var exports = function(dokumentstatusNr, bezeichnung, sperren, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;
  ...
  /**
   * Constructs a <code>AUFDokumentstatusDokumentstatusNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AUFDokumentstatusDokumentstatusNr} obj Optional instance to populate.
   * @return {module:model/AUFDokumentstatusDokumentstatusNr} The populated <code>AUFDokumentstatusDokumentstatusNr</code> instance.
   */
