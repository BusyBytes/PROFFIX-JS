...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.DEBBuchungzahlungerfassenMehrereBelegeRequest = factory(root.ProffixRestApiRequestSammlung.ApiClient, root.ProffixRestApiRequestSammlung.Adresse, root.ProffixRestApiRequestSammlung.Belege, root.ProffixRestApiRequestSammlung.Buchungen3);
  }
  ...
  /**
   * The DEBBuchungzahlungerfassenMehrereBelegeRequest model module.
   * @module model/DEBBuchungzahlungerfassenMehrereBelegeRequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>DEBBuchungzahlungerfassenMehrereBelegeRequest</code>.
   * @alias module:model/DEBBuchungzahlungerfassenMehrereBelegeRequest
   * @class
  ...
  /**
   * Constructs a <code>DEBBuchungzahlungerfassenMehrereBelegeRequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DEBBuchungzahlungerfassenMehrereBelegeRequest} obj Optional instance to populate.
   * @return {module:model/DEBBuchungzahlungerfassenMehrereBelegeRequest} The populated <code>DEBBuchungzahlungerfassenMehrereBelegeRequest</code> instance.
   */
