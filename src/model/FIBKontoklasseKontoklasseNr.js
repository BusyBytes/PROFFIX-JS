...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.ProffixRestApiRequestSammlung.FIBKontoklasseKontoklasseNr = factory(root.ProffixRestApiRequestSammlung.ApiClient);
  }
  ...
  /**
   * The FIBKontoklasseKontoklasseNr model module.
   * @module model/FIBKontoklasseKontoklasseNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>FIBKontoklasseKontoklasseNr</code>.
   * @alias module:model/FIBKontoklasseKontoklasseNr
   * @class
   ...
   */
  var exports = function(kontoklasseNr, bezeichnung, kontotyp, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;
  ...
  /**
   * Constructs a <code>FIBKontoklasseKontoklasseNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/FIBKontoklasseKontoklasseNr} obj Optional instance to populate.
   * @return {module:model/FIBKontoklasseKontoklasseNr} The populated <code>FIBKontoklasseKontoklasseNr</code> instance.
   */
