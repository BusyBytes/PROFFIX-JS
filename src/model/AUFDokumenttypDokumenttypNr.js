...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Zusatzfelder5'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Zusatzfelder5'));
  } else {
    // Browser globals (root is window)
    if (!root.ProffixRestApiRequestSammlung) {
      root.ProffixRestApiRequestSammlung = {};
    }
    root.ProffixRestApiRequestSammlung.AUFDokumenttypDokumenttypNr = factory(root.ProffixRestApiRequestSammlung.ApiClient, root.ProffixRestApiRequestSammlung.Zusatzfelder5);
  }
}(this, function(ApiClient, Zusatzfelder5) {
  'use strict';
  ...
  /**
   * The AUFDokumenttypDokumenttypNr model module.
   * @module model/AUFDokumenttypDokumenttypNr
   * @version 1.0
   */

  /**
   * Constructs a new <code>AUFDokumenttypDokumenttypNr</code>.
   * @alias module:model/AUFDokumenttypDokumenttypNr
   * @class
   ...
   * @param zusatzfelder {module:model/Zusatzfelder5} 
   */
  var exports = function(dokumenttypNr, bezeichnung, inaktiv, erstelltAm, erstelltVon, geaendertAm, geaendertVon, zusatzfelder) {
    var _this = this;
  ...
  /**
   * Constructs a <code>AUFDokumenttypDokumenttypNr</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AUFDokumenttypDokumenttypNr} obj Optional instance to populate.
   * @return {module:model/AUFDokumenttypDokumenttypNr} The populated <code>AUFDokumenttypDokumenttypNr</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Zusatzfelder')) {
        obj['Zusatzfelder'] = Zusatzfelder5.constructFromObject(data['Zusatzfelder']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/Zusatzfelder5} Zusatzfelder
   */
